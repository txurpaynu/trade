...
warn("Mock Trade Script already loaded - skipping duplicate execution")
return
end
...
require(Services.ReplicatedStorage:WaitForChild('Fsys')).load('SettingsHelper')
...
task.wait(0.1)
local FamilyHelper =
require(Services.ReplicatedStorage:WaitForChild('Fsys')).load('FamilyHelper')
...
if player1 and player2 and (fakePlayerIds[player1.UserId] or
fakePlayerIds[player2.UserId]) then return false end
...
Services.Players.LocalPlayer.PlayerGui.TradeApp.Frame.NegotiationFrame
...
local ColorThemeManagerColor = Modules.ColorThemeManager.lookup(FriendValue and
'background' or 'saturated')
...
NegotiationFrame.Header.PartnerFrame.NameLabel.Text =
CONFIG.PARTNER_NAME
end
end)
end
...
local routerInit
local routerUpvalueIndex
for idx = 1, 20 do
local ok, up = pcall(debug.getupvalue, Modules.RouterClient.init, idx)
if not ok then break end
if type(up) == "table" then
local looksLikeRemotes = false
for k, v in pairs(up) do
if type(k) == "string" and typeof(v) == "Instance" then
looksLikeRemotes = true
end
break
end
if looksLikeRemotes then
routerInit = up
routerUpvalueIndex = idx
break
end
end
end
_G.__m0_3a_routerUpvalueIndex = routerUpvalueIndex
if routerInit then
for i, v in pairs(routerInit) do
pcall(function() v.Name = i end)
originalRemotes[i] = v
end
else
warn("[m0_3a] could not locate RouterClient remotes upvalue")
end
...
if routerUpvalueIndex then
pcall(function()
debug.setupvalue(Modules.RouterClient.init, routerUpvalueIndex,
setmetatable({
...
Apps.TradeHistoryApp._create_trade_frame =
Apps.TradeHistoryApp._ORIGINAL_create_trade_frame
end
if Apps.TradeApp._ORIGINAL_change_local_trade_state then
Apps.TradeApp._change_local_trade_state =
Apps.TradeApp._ORIGINAL_change_local_trade_state
end
if Apps.TradeApp._ORIGINAL_overwrite_local_trade_state then

Apps.TradeApp._overwrite_local_trade_state =
Apps.TradeApp._ORIGINAL_overwrite_local_trade_state
end
Apps.TradeHistoryApp._ORIGINAL_create_trade_frame =
Apps.TradeHistoryApp._create_trade_frame
Apps.TradeApp._ORIGINAL_change_local_trade_state =
...
elseif state.recipient == Services.Players.LocalPlayer and change.recipient_offer
then
spawnTradeOffers[state.trade_id] = {
...
do
local spawnData
local _spawnOverwrite =
Modules.UIManager.apps.TradeApp._overwrite_local_trade_state
Modules.UIManager.apps.TradeApp._overwrite_local_trade_state = function(self, trade,
...)
if trade then
local offer = trade.sender == Services.Players.LocalPlayer and trade.sender_offer or
trade.recipient == Services.Players.LocalPlayer and trade.recipient_offer
if offer then
...
if trade then
local team = trade.sender == Services.Players.LocalPlayer and "sender_offer" or
trade.recipient == Services.Players.LocalPlayer and "recipient_offer"
if team then
...
["Bat Dragon"] = {name = "Bat Dragon", ["rvalue - nopotion"] = 503, ["rvalue - fly&ride"] =
491, ["nvalue - fly&ride"] = 1280, ["mvalue - fly&ride"] = 3620},
["Shadow Dragon"] = {name = "Shadow Dragon", ["rvalue - nopotion"] = 473, ["rvalue fly&ride"] = 331, ["nvalue - fly&ride"] = 777, ["mvalue - fly&ride"] = 1950},
["Giraffe"] = {name = "Giraffe", ["rvalue - nopotion"] = 230, ["rvalue - fly&ride"] = 220,
["nvalue - fly&ride"] = 536, ["mvalue - fly&ride"] = 1870},
["Frost Dragon"] = {name = "Frost Dragon", ["rvalue - nopotion"] = 181, ["rvalue - fly&ride"]
= 170, ["nvalue - fly&ride"] = 361, ["mvalue - fly&ride"] = 1050},
["Owl"] = {name = "Owl", ["rvalue - nopotion"] = 144, ["rvalue - fly&ride"] = 142, ["nvalue fly&ride"] = 389, ["mvalue - fly&ride"] = 1430},
["Parrot"] = {name = "Parrot", ["rvalue - nopotion"] = 112.5, ["rvalue - fly&ride"] = 111.5,
["nvalue - fly&ride"] = 242, ["mvalue - fly&ride"] = 840},
["Crow"] = {name = "Crow", ["rvalue - nopotion"] = 93, ["rvalue - fly&ride"] = 92.5, ["nvalue fly&ride"] = 233, ["mvalue - fly&ride"] = 920},
["Evil Unicorn"] = {name = "Evil Unicorn", ["rvalue - nopotion"] = 80.5, ["rvalue - fly&ride"] =
80, ["nvalue - fly&ride"] = 174, ["mvalue - fly&ride"] = 670},
["African Wild Dog"] = {name = "African Wild Dog", ["rvalue - nopotion"] = 57, ["rvalue fly&ride"] = 58, ["nvalue - fly&ride"] = 192, ["mvalue - fly&ride"] = 720},
["Hedgehog"] = {name = "Hedgehog", ["rvalue - nopotion"] = 53.5, ["rvalue - fly&ride"] =
54, ["nvalue - fly&ride"] = 182, ["mvalue - fly&ride"] = 705},
...
["Blazing Lion"] = {name = "Blazing Lion", ["rvalue - nopotion"] = 46, ["rvalue - fly&ride"] =
48, ["nvalue - fly&ride"] = 175, ["mvalue - fly&ride"] = 708},
["Orchid Butterfly"] = {name = "Orchid Butterfly", ["rvalue - nopotion"] = 44, ["rvalue fly&ride"] = 45, ["nvalue - fly&ride"] = 183, ["mvalue - fly&ride"] = 735},
["Dalmatian"] = {name = "Dalmatian", ["rvalue - nopotion"] = 43.5, ["rvalue - fly&ride"] = 44,
["nvalue - fly&ride"] = 134, ["mvalue - fly&ride"] = 490},
["Arctic Reindeer"] = {name = "Arctic Reindeer", ["rvalue - nopotion"] = 39, ["rvalue fly&ride"] = 38, ["nvalue - fly&ride"] = 80, ["mvalue - fly&ride"] = 302},
["Giant Panda"] = {name = "Giant Panda", ["rvalue - nopotion"] = 35, ["rvalue - fly&ride"] =
35, ["nvalue - fly&ride"] = 155, ["mvalue - fly&ride"] = 650},
["Cryptid"] = {name = "Cryptid", ["rvalue - nopotion"] = 26.5, ["rvalue - fly&ride"] = 28,
["nvalue - fly&ride"] = 97, ["mvalue - fly&ride"] = 330},

["Haetae"] = {name = "Haetae", ["rvalue - nopotion"] = 25.5, ["rvalue - fly&ride"] = 26,
["nvalue - fly&ride"] = 105, ["mvalue - fly&ride"] = 430},
["Cow"] = {name = "Cow", ["rvalue - nopotion"] = 23, ["rvalue - fly&ride"] = 25.5, ["nvalue fly&ride"] = 58.5, ["mvalue - fly&ride"] = 212},
["Pelican"] = {name = "Pelican", ["rvalue - nopotion"] = 24, ["rvalue - fly&ride"] = 25,
["nvalue - fly&ride"] = 99, ["mvalue - fly&ride"] = 410},
["Strawberry Shortcake Bat Dragon"] = {name = "Strawberry Shortcake Bat Dragon",
["rvalue - nopotion"] = 22, ["rvalue - fly&ride"] = 23.5, ["nvalue - fly&ride"] = 69, ["mvalue fly&ride"] = 217},
["Peppermint Penguin"] = {name = "Peppermint Penguin", ["rvalue - nopotion"] = 21.25,
["rvalue - fly&ride"] = 22.75, ["nvalue - fly&ride"] = 71, ["mvalue - fly&ride"] = 240},
["Turtle"] = {name = "Turtle", ["rvalue - nopotion"] = 20, ["rvalue - fly&ride"] = 22.5, ["nvalue
- fly&ride"] = 48.5, ["mvalue - fly&ride"] = 128.5},
["Chocolate Chip Bat Dragon"] = {name = "Chocolate Chip Bat Dragon", ["rvalue nopotion"] = 20, ["rvalue - fly&ride"] = 21.5, ["nvalue - fly&ride"] = 67, ["mvalue - fly&ride"] =
214},
["Monkey King"] = {name = "Monkey King", ["rvalue - nopotion"] = 21, ["rvalue - fly&ride"] =
20, ["nvalue - fly&ride"] = 69, ["mvalue - fly&ride"] = 275},
["Flamingo"] = {name = "Flamingo", ["rvalue - nopotion"] = 17.5, ["rvalue - fly&ride"] = 18,
["nvalue - fly&ride"] = 71, ["mvalue - fly&ride"] = 280},
["Mini Pig"] = {name = "Mini Pig", ["rvalue - nopotion"] = 17.5, ["rvalue - fly&ride"] = 18,
["nvalue - fly&ride"] = 72, ["mvalue - fly&ride"] = 295},
["Hot Doggo"] = {name = "Hot Doggo", ["rvalue - nopotion"] = 16, ["rvalue - fly&ride"] =
16.5, ["nvalue - fly&ride"] = 68, ["mvalue - fly&ride"] = 286},
["Kangaroo"] = {name = "Kangaroo", ["rvalue - nopotion"] = 15, ["rvalue - fly&ride"] = 16.5,
["nvalue - fly&ride"] = 36, ["mvalue - fly&ride"] = 101.5},
["Albino Monkey"] = {name = "Albino Monkey", ["rvalue - nopotion"] = 15.25, ["rvalue fly&ride"] = 15.5, ["nvalue - fly&ride"] = 50, ["mvalue - fly&ride"] = 204},
["Elephant"] = {name = "Elephant", ["rvalue - nopotion"] = 15, ["rvalue - fly&ride"] = 15.5,
["nvalue - fly&ride"] = 47.5, ["mvalue - fly&ride"] = 195},
...
["Crocodile"] = {name = "Crocodile", ["rvalue - nopotion"] = 11.75, ["rvalue - fly&ride"] =
12.75, ["nvalue - fly&ride"] = 43, ["mvalue - fly&ride"] = 172},
["Blue Dog"] = {name = "Blue Dog", ["rvalue - nopotion"] = 12, ["rvalue - fly&ride"] = 12,
["nvalue - fly&ride"] = 42, ["mvalue - fly&ride"] = 162},
["Sugar Glider"] = {name = "Sugar Glider", ["rvalue - nopotion"] = 11.5, ["rvalue - fly&ride"]
= 12, ["nvalue - fly&ride"] = 49, ["mvalue - fly&ride"] = 207},
["Caterpillar"] = {name = "Caterpillar", ["rvalue - nopotion"] = 11.5, ["rvalue - fly&ride"] = 12,
["nvalue - fly&ride"] = 50, ["mvalue - fly&ride"] = 210},
...
["Winged Tiger"] = {name = "Winged Tiger", ["rvalue - nopotion"] = 7, ["rvalue - fly&ride"] =
7.5, ["nvalue - fly&ride"] = 33.5, ["mvalue - fly&ride"] = 146},
["Goat"] = {name = "Goat", ["rvalue - nopotion"] = 6.75, ["rvalue - fly&ride"] = 7.25, ["nvalue
- fly&ride"] = 30, ["mvalue - fly&ride"] = 136},

["Lion Cub"] = {name = "Lion Cub", ["rvalue - nopotion"] = 6.5, ["rvalue - fly&ride"] = 7,
["nvalue - fly&ride"] = 29.5, ["mvalue - fly&ride"] = 131},
["Sheeeeep"] = {name = "Sheeeeep", ["rvalue - nopotion"] = 5.5, ["rvalue - fly&ride"] = 6,
["nvalue - fly&ride"] = 25, ["mvalue - fly&ride"] = 113},
["Shark Puppy"] = {name = "Shark Puppy", ["rvalue - nopotion"] = 5.5, ["rvalue - fly&ride"]
= 6, ["nvalue - fly&ride"] = 27, ["mvalue - fly&ride"] = 117},
["Jellyfish"] = {name = "Jellyfish", ["rvalue - nopotion"] = 5.5, ["rvalue - fly&ride"] = 6,
["nvalue - fly&ride"] = 25, ["mvalue - fly&ride"] = 113},
["Meerkat"] = {name = "Meerkat", ["rvalue - nopotion"] = 5.25, ["rvalue - fly&ride"] = 5.75,
["nvalue - fly&ride"] = 26, ["mvalue - fly&ride"] = 114},
["Nessie"] = {name = "Nessie", ["rvalue - nopotion"] = 5, ["rvalue - fly&ride"] = 5.5, ["nvalue
- fly&ride"] = 24, ["mvalue - fly&ride"] = 109},
["Pink Cat"] = {name = "Pink Cat", ["rvalue - nopotion"] = 4.75, ["rvalue - fly&ride"] = 5.25,
["nvalue - fly&ride"] = 20, ["mvalue - fly&ride"] = 86},
...
["Unicorn"] = {name = "Unicorn", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"] = 4, ["nvalue
- fly&ride"] = 15, ["mvalue - fly&ride"] = 44},
["Happy Clam"] = {name = "Happy Clam", ["rvalue - nopotion"] = 3.25, ["rvalue - fly&ride"]
= 3.75, ["nvalue - fly&ride"] = 16, ["mvalue - fly&ride"] = 68},
...
["Lunar Tiger"] = {name = "Lunar Tiger", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] =
0.55, ["nvalue - fly&ride"] = 0.75, ["mvalue - fly&ride"] = 2.5},
["King Bee"] = {name = "King Bee", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3,
["nvalue - fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
["Queen Bee"] = {name = "Queen Bee", ["rvalue - nopotion"] = 8, ["rvalue - fly&ride"] = 8.5,
["nvalue - fly&ride"] = 35, ["mvalue - fly&ride"] = 145},
["Dragon"] = {name = "Dragon", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5,
["nvalue - fly&ride"] = 10, ["mvalue - fly&ride"] = 40},
...
["Golden Griffin"] = {name = "Golden Griffin", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"]
= 3.5, ["nvalue - fly&ride"] = 14, ["mvalue - fly&ride"] = 58},
...
["Frost Fury"] = {name = "Frost Fury", ["rvalue - nopotion"] = 4, ["rvalue - fly&ride"] = 4.5,
["nvalue - fly&ride"] = 18, ["mvalue - fly&ride"] = 75},
["Snow Owl"] = {name = "Snow Owl", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5,
["nvalue - fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
...
["Skele-Rex"] = {name = "Skele-Rex", ["rvalue - nopotion"] = 4, ["rvalue - fly&ride"] = 4.5,
["nvalue - fly&ride"] = 18, ["mvalue - fly&ride"] = 75},
["Cerberus"] = {name = "Cerberus", ["rvalue - nopotion"] = 1.5, ["rvalue - fly&ride"] = 2,
["nvalue - fly&ride"] = 8, ["mvalue - fly&ride"] = 33},
["Robo Dog"] = {name = "Robo Dog", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Guardian Lion"] = {name = "Guardian Lion", ["rvalue - nopotion"] = 1.5, ["rvalue fly&ride"] = 2, ["nvalue - fly&ride"] = 8, ["mvalue - fly&ride"] = 33},
["Peacock"] = {name = "Peacock", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5,
["nvalue - fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
["Axolotl"] = {name = "Axolotl", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3, ["nvalue
- fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
["Phoenix"] = {name = "Phoenix", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"] = 3.5,
["nvalue - fly&ride"] = 14, ["mvalue - fly&ride"] = 58},
["Goldhorn"] = {name = "Goldhorn", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5,
["nvalue - fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
["Shark"] = {name = "Shark", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3, ["nvalue fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
["Octopus"] = {name = "Octopus", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"] = 3.5,
["nvalue - fly&ride"] = 14, ["mvalue - fly&ride"] = 58},
["Metal Ox"] = {name = "Metal Ox", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
...
["Capricorn"] = {name = "Capricorn", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3,
["nvalue - fly&ride"] = 12, ["mvalue - fly&ride"] = 50},

["Lavender Dragon"] = {name = "Lavender Dragon", ["rvalue - nopotion"] = 10, ["rvalue fly&ride"] = 10.5, ["nvalue - fly&ride"] = 42, ["mvalue - fly&ride"] = 175},
["Ice Golem"] = {name = "Ice Golem", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3,
["nvalue - fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
["Hawk"] = {name = "Hawk", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5, ["nvalue fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
["Chimera"] = {name = "Chimera", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3,
["nvalue - fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
["Maneki-Neko"] = {name = "Maneki-Neko", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"] =
3.5, ["nvalue - fly&ride"] = 14, ["mvalue - fly&ride"] = 58},
["Winged Horse"] = {name = "Winged Horse", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"]
= 3.5, ["nvalue - fly&ride"] = 14, ["mvalue - fly&ride"] = 58},
["Fallow Deer"] = {name = "Fallow Deer", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] =
2.5, ["nvalue - fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
["Mechapup"] = {name = "Mechapup", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Albino Bat"] = {name = "Albino Bat", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Arctic Fox"] = {name = "Arctic Fox", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3,
["nvalue - fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
...
["Clownfish"] = {name = "Clownfish", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Deinonychus"] = {name = "Deinonychus", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] =
1.5, ["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Frog"] = {name = "Frog", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5, ["nvalue fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Ghost Bunny"] = {name = "Ghost Bunny", ["rvalue - nopotion"] = 1.5, ["rvalue - fly&ride"]
= 2, ["nvalue - fly&ride"] = 8, ["mvalue - fly&ride"] = 33},
["Ginger Cat"] = {name = "Ginger Cat", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] =
0.75, ["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
["Horse"] = {name = "Horse", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] = 0.75,
["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
...
["Penguin"] = {name = "Penguin", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Pig"] = {name = "Pig", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5, ["nvalue fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
["Platypus"] = {name = "Platypus", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"] = 3.5,
["nvalue - fly&ride"] = 14, ["mvalue - fly&ride"] = 58},

["Red Panda"] = {name = "Red Panda", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] =
0.75, ["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
["Shiba Inu"] = {name = "Shiba Inu", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] =
0.75, ["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
["Sloth"] = {name = "Sloth", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1, ["nvalue fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Starfish"] = {name = "Starfish", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Turkey"] = {name = "Turkey", ["rvalue - nopotion"] = 4, ["rvalue - fly&ride"] = 4.5, ["nvalue
- fly&ride"] = 18, ["mvalue - fly&ride"] = 75},
["Zombie Buffalo"] = {name = "Zombie Buffalo", ["rvalue - nopotion"] = 4.25, ["rvalue fly&ride"] = 4.75, ["nvalue - fly&ride"] = 21, ["mvalue - fly&ride"] = 94},
["Toy Monkey"] = {name = "Toy Monkey", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] =
3, ["nvalue - fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
["Toucan"] = {name = "Toucan", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1, ["nvalue
- fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
...
["Brown Bear"] = {name = "Brown Bear", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"] =
3.5, ["nvalue - fly&ride"] = 14, ["mvalue - fly&ride"] = 58},
["Polar Bear"] = {name = "Polar Bear", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5,
["nvalue - fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
["Hyena"] = {name = "Hyena", ["rvalue - nopotion"] = 3, ["rvalue - fly&ride"] = 3.5, ["nvalue fly&ride"] = 14, ["mvalue - fly&ride"] = 58},
["Wild Boar"] = {name = "Wild Boar", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5,
["nvalue - fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
["Capybara"] = {name = "Capybara", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3,
["nvalue - fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
["Merhorse"] = {name = "Merhorse", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Sabertooth"] = {name = "Sabertooth", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Ladybug"] = {name = "Ladybug", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Wyvern"] = {name = "Wyvern", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Hydra"] = {name = "Hydra", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5, ["nvalue fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["St. Bernard"] = {name = "St. Bernard", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Squirrel"] = {name = "Squirrel", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Pine Marten"] = {name = "Pine Marten", ["rvalue - nopotion"] = 0.75, ["rvalue - fly&ride"] =
1.25, ["nvalue - fly&ride"] = 5, ["mvalue - fly&ride"] = 21},
["Crab"] = {name = "Crab", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1, ["nvalue fly&ride"] = 4, ["mvalue - fly&ride"] = 17},

["Dalmation"] = {name = "Dalmation", ["rvalue - nopotion"] = 43.5, ["rvalue - fly&ride"] = 44,
["nvalue - fly&ride"] = 134, ["mvalue - fly&ride"] = 490},
["Australian Kelpie"] = {name = "Australian Kelpie", ["rvalue - nopotion"] = 0.1, ["rvalue fly&ride"] = 0.5, ["nvalue - fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Beaver"] = {name = "Beaver", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5,
["nvalue - fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Bunny"] = {name = "Bunny", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5,
["nvalue - fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Cow"] = {name = "Cow", ["rvalue - nopotion"] = 23, ["rvalue - fly&ride"] = 25.5, ["nvalue fly&ride"] = 58.5, ["mvalue - fly&ride"] = 212},
["Elephant"] = {name = "Elephant", ["rvalue - nopotion"] = 15, ["rvalue - fly&ride"] = 15.5,
["nvalue - fly&ride"] = 47.5, ["mvalue - fly&ride"] = 195},
["Emu"] = {name = "Emu", ["rvalue - nopotion"] = 0.15, ["rvalue - fly&ride"] = 0.6, ["nvalue fly&ride"] = 2.5, ["mvalue - fly&ride"] = 10},
["Monkey"] = {name = "Monkey", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] = 0.75,
["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
["Ox"] = {name = "Ox", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5, ["nvalue fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Rabbit"] = {name = "Rabbit", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5,
["nvalue - fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Rat"] = {name = "Rat", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1, ["nvalue fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Reindeer"] = {name = "Reindeer", ["rvalue - nopotion"] = 1, ["rvalue - fly&ride"] = 1.5,
["nvalue - fly&ride"] = 6, ["mvalue - fly&ride"] = 25},
["Snow Puma"] = {name = "Snow Puma", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] =
0.5, ["nvalue - fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Swan"] = {name = "Swan", ["rvalue - nopotion"] = 1.5, ["rvalue - fly&ride"] = 2, ["nvalue fly&ride"] = 8, ["mvalue - fly&ride"] = 33},
["Musk Ox"] = {name = "Musk Ox", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
...
["Pterodactyl"] = {name = "Pterodactyl", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Ground Sloth"] = {name = "Ground Sloth", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"]
= 1, ["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Seahorse"] = {name = "Seahorse", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] =
0.75, ["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
["Narwhal"] = {name = "Narwhal", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Butterfly"] = {name = "Butterfly", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5,
["nvalue - fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Ibex"] = {name = "Ibex", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1, ["nvalue fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Salamander"] = {name = "Salamander", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] =
0.75, ["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},

["Poodle"] = {name = "Poodle", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] = 0.75,
["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
...
["Capybara"] = {name = "Capybara", ["rvalue - nopotion"] = 2.5, ["rvalue - fly&ride"] = 3,
["nvalue - fly&ride"] = 12, ["mvalue - fly&ride"] = 50},
["Chocolate Labrador"] = {name = "Chocolate Labrador", ["rvalue - nopotion"] = 0.05,
["rvalue - fly&ride"] = 0.45, ["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Dingo"] = {name = "Dingo", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] = 0.45,
["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Dolphin"] = {name = "Dolphin", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] = 0.45,
["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Drake"] = {name = "Drake", ["rvalue - nopotion"] = 0.15, ["rvalue - fly&ride"] = 0.6,
["nvalue - fly&ride"] = 2.5, ["mvalue - fly&ride"] = 10},
["Fennic Fox"] = {name = "Fennic Fox", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] =
0.45, ["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Glyptodon"] = {name = "Glyptodon", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] =
0.45, ["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
...
["Pink Cat"] = {name = "Pink Cat", ["rvalue - nopotion"] = 4.75, ["rvalue - fly&ride"] = 5.25,
["nvalue - fly&ride"] = 20, ["mvalue - fly&ride"] = 86},
["Puma"] = {name = "Puma", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] = 0.45,
["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Silly Duck"] = {name = "Silly Duck", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Snow Cat"] = {name = "Snow Cat", ["rvalue - nopotion"] = 0.03, ["rvalue - fly&ride"] =
0.43, ["nvalue - fly&ride"] = 1, ["mvalue - fly&ride"] = 4},
["Snowman"] = {name = "Snowman", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5,
["nvalue - fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Stegosaurus"] = {name = "Stegosaurus", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"]
= 0.45, ["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Triceratops"] = {name = "Triceratops", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] =
0.45, ["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Wild Boar"] = {name = "Wild Boar", ["rvalue - nopotion"] = 2, ["rvalue - fly&ride"] = 2.5,
["nvalue - fly&ride"] = 10, ["mvalue - fly&ride"] = 42},
["Wolf"] = {name = "Wolf", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] = 0.45, ["nvalue
- fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Robin"] = {name = "Robin", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] = 0.75,
["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
["Coyote"] = {name = "Coyote", ["rvalue - nopotion"] = 0.05, ["rvalue - fly&ride"] = 0.45,
["nvalue - fly&ride"] = 1.5, ["mvalue - fly&ride"] = 6},
["Puffin"] = {name = "Puffin", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5, ["nvalue
- fly&ride"] = 2, ["mvalue - fly&ride"] = 8},

["Bandicoot"] = {name = "Bandicoot", ["rvalue - nopotion"] = 0.02, ["rvalue - fly&ride"] =
0.42, ["nvalue - fly&ride"] = 0.5, ["mvalue - fly&ride"] = 1.5},
["Buffalo"] = {name = "Buffalo", ["rvalue - nopotion"] = 0.02, ["rvalue - fly&ride"] = 0.42,
["nvalue - fly&ride"] = 0.5, ["mvalue - fly&ride"] = 1.5},
["Cat"] = {name = "Cat", ["rvalue - nopotion"] = 0.02, ["rvalue - fly&ride"] = 0.42, ["nvalue fly&ride"] = 0.5, ["mvalue - fly&ride"] = 1.5},
["Chicken"] = {name = "Chicken", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1,
["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Chick"] = {name = "Chick", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"] = 1, ["nvalue fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Dog"] = {name = "Dog", ["rvalue - nopotion"] = 0.02, ["rvalue - fly&ride"] = 0.42, ["nvalue fly&ride"] = 0.5, ["mvalue - fly&ride"] = 1.5},
["Ground Sloth"] = {name = "Ground Sloth", ["rvalue - nopotion"] = 0.5, ["rvalue - fly&ride"]
= 1, ["nvalue - fly&ride"] = 4, ["mvalue - fly&ride"] = 17},
["Otter"] = {name = "Otter", ["rvalue - nopotion"] = 0.02, ["rvalue - fly&ride"] = 0.42, ["nvalue
- fly&ride"] = 0.5, ["mvalue - fly&ride"] = 1.5},
["Robin"] = {name = "Robin", ["rvalue - nopotion"] = 0.25, ["rvalue - fly&ride"] = 0.75,
["nvalue - fly&ride"] = 3, ["mvalue - fly&ride"] = 12},
["Tasmanian Tiger"] = {name = "Tasmanian Tiger", ["rvalue - nopotion"] = 0.03, ["rvalue fly&ride"] = 0.43, ["nvalue - fly&ride"] = 1, ["mvalue - fly&ride"] = 4},
["Stingray"] = {name = "Stingray", ["rvalue - nopotion"] = 0.02, ["rvalue - fly&ride"] = 0.42,
["nvalue - fly&ride"] = 0.5, ["mvalue - fly&ride"] = 1.5},
["Bullfrog"] = {name = "Bullfrog", ["rvalue - nopotion"] = 0.02, ["rvalue - fly&ride"] = 0.42,
["nvalue - fly&ride"] = 0.5, ["mvalue - fly&ride"] = 1.5},
["Walrus"] = {name = "Walrus", ["rvalue - nopotion"] = 0.02, ["rvalue - fly&ride"] = 0.42,
["nvalue - fly&ride"] = 0.5, ["mvalue - fly&ride"] = 1.5},
["Ox"] = {name = "Ox", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5, ["nvalue fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
["Lunar Ox"] = {name = "Lunar Ox", ["rvalue - nopotion"] = 0.1, ["rvalue - fly&ride"] = 0.5,
["nvalue - fly&ride"] = 2, ["mvalue - fly&ride"] = 8},
}
...
["Cookie"] = "_ga=GA1.1.28803348.1771957003;
lb=2a0a:ef40:1041:701:9073:1fb2:cb8:ba21;
csrfToken=737a8ba21227434fabfce2068cb9c708;
_ga_63HD5JLYR9=GS2.1.s1772828220$o2$g1$t1772828232$j48$l0$h0"
...
if slotData.widget_kind == "collection" and slotData.widget_data and
slotData.widget_data.items then
...
'Did I win?', 'Which one can I spin', 'Omg Its real Thank you so much', 'I am a big fan pls
pet',
...
local variation = math.random(CONFIG.SPECTATOR_VARIATION_MIN,
CONFIG.SPECTATOR_VARIATION_MAX)
...
'Elephant', 'Chocolate Chip Bat Dragon', 'Cow', 'Albino Monkey', 'Peppermint Penguin',
'Flamingo', 'Balloon Unicorn',
}
local customUsers = {
...
local result =
Modules.RouterClient.get('TradeAPI/GetTradeLicenseStatus'):InvokeServer(player.UserId)
...
'refresh_all', '_evaluate_trade_fairness', '_show_scam_victim_warning',
...
local partnerDisplayName = player and player.DisplayName or
CONFIG.PARTNER_NAME
...
sender_offer = { items = {}, player_name = Services.Players.LocalPlayer.Name,
negotiated = false, confirmed = false },
recipient_offer = { items = {}, player_name = CONFIG.PARTNER_NAME, negotiated =
...
self.UIManager.apps.DialogApp:dialog({ text = 'Report submitted for review.',
button = 'Close', yields = false })
end
if self.instance.Frame.Visible then self:_refresh() else self:_clear_scrolling_frame()
end
return
end
...
if not mockState.active or not mockState.trade then return false, 'No active mock trade'
end
if mockState.trade.current_stage == 'confirmation' then return false, 'Cannot modify during
confirmation' end
...
properties = { flyable = flags.F, rideable = flags.R, neon = flags.N, mega_neon
= flags.M, age = 1 },
}
...
if Apps.TradeApp._lock_trade_for_appropriate_time then
Apps.TradeApp:_lock_trade_for_appropriate_time() end
if Apps.TradeApp._render_message_in_trade_chat then
Apps.TradeApp:_render_message_in_trade_chat(nil, string.format('%s added
%s.', CONFIG.PARTNER_NAME, petName), true)
end
...
Apps.TradeApp:_render_message_in_trade_chat(nil, string.format('%s removed %s.',
CONFIG.PARTNER_NAME, itemName), true)
end
...
Apps.TradeApp:_render_message_in_trade_chat(nil, string.format('%s: %s',
CONFIG.PARTNER_NAME, message), true)
return true
end
return false
end
...
while Apps.TradeApp.lock_countdown and Apps.TradeApp.lock_countdown.is_going and
Apps.TradeApp.lock_countdown:is_going() do
task.wait(0.1)
end
...
mockState.trade.offer_version = mockState.trade.offer_version + 1
Apps.TradeApp:_overwrite_local_trade_state(mockState.trade)
if Apps.TradeApp._evaluate_trade_fairness then
Apps.TradeApp:_evaluate_trade_fairness() end
if Apps.TradeApp._lock_trade_for_appropriate_time then
Apps.TradeApp:_lock_trade_for_appropriate_time() end
else
mockState.trade.offer_version = mockState.trade.offer_version + 1
...
if Apps.TradeApp._set_confirmation_arrow_rotating then
Apps.TradeApp:_set_confirmation_arrow_rotating(true) end
task.wait(3)
...
if Apps.HintApp then Apps.HintApp:hint({ text = 'The trade was successful!', length
= 5, overridable = true }) end
if Apps.TradeHistoryApp and Modules.UIManager.is_visible('TradeHistoryApp')
then Apps.TradeHistoryApp:_refresh() end
end
end
end
mockState.partnerActionPending = false
...
if mockState.active and mockState.trade then return
Modules.TableUtil.deep_copy(mockState.trade) end
...
if mockState.trade then mockState.trade.subscriber_count =
CONFIG.SPECTATOR_COUNT end
if self._on_local_trade_state_changed then
self:_on_local_trade_state_changed(newState, newState) end
...
if Services.Players.LocalPlayer == state.sender then return state.sender_offer,
'sender_offer' else return state.recipient_offer, 'recipient_offer' end
end
...
local state = self:_get_local_trade_state()
if mockState.active and state then
if Services.Players.LocalPlayer == state.sender then return state.recipient_offer,
'recipient_offer' else return state.sender_offer, 'sender_offer' end
end
...
if mockState.active and mockState.trade then return mockState.trade.current_stage
end
...
recursiveMerge(target[k], v) else target[k] = v end
end
return target
end
self:_overwrite_local_trade_state(recursiveMerge(self:_get_local_trade_state(),
changes))
else
...
if mockState.active and mockState.trade then
if self:_get_current_trade_stage() == 'negotiation' then return
CONFIG.NEGOTIATION_LOCK
else return math.clamp(CONFIG.CONFIRMATION_LOCK_PER_ITEM *
(#mockState.trade.sender_offer.items + #mockState.trade.recipient_offer.items), 5, 15) end
end
return mockState.originalFunctions._get_lock_time(self)
end
Apps.TradeApp._lock_trade_for_appropriate_time = function(self)
if mockState.active then
if self.lock_countdown then self.lock_countdown:stop()
self.lock_countdown:set_duration(self:_get_lock_time()) self.lock_countdown:start() end
else
...
Apps.BackpackApp:set_item_unique_hidden(pickedItem.unique,
'TradeApp')
end
end)
end
...
self:_lock_trade_for_appropriate_time() end

if Apps.BackpackApp.reset_hidden_item_tag then
Apps.BackpackApp:reset_hidden_item_tag('TradeApp') end
break
end
end
else
...
if CONFIG.AUTO_PARTNER and not mockState.trade.recipient_offer.negotiated and
mockState.trade.sender_offer.negotiated then task.spawn(partnerAutoAction) end
else
...
task.spawn(partnerAutoAction) end
else
...
Apps.DialogApp:dialog({ text = 'This trade seems unbalanced. Be careful - you
could be getting scammed.', button = 'Next', yields = false })
Apps.DialogApp:dialog({ text = 'Any items lost to scams WILL NOT be returned.
Be sure before you accept!', button = 'I understand', yields = false })
...
mockState.isMockTradeDialog = false
pcall(function() if Apps.DialogApp and Apps.DialogApp.close then Apps.DialogApp:close()
end end)
pcall(function() if Apps.DialogApp and Apps.DialogApp._close then
Apps.DialogApp:_close() end end)
...
Apps.HintApp:hint({ text = 'Error starting trade: ' .. tostring(err), length = 5, overridable =
true })
end
end
local function showTradeRequest()
if mockState.pendingTradeRequest or mockState.active or
mockState.tradeRequestBlocked then
return
end
mockState.pendingTradeRequest = true
mockState.canShowTradeRequest = false
task.wait(CONFIG.TRADE_REQUEST_DELAY)
if not mockState.pendingTradeRequest or mockState.active or
mockState.tradeRequestBlocked then
mockState.pendingTradeRequest = false
mockState.canShowTradeRequest = true
return
...
local dialogResult
local success, err = pcall(function()
local dialogTable = CONFIG.FRIEND_PARTNER and trade_request_table_friend or
trade_request_table_not_friend
...
mockState.isMockTradeDialog = false
mockState.pendingTradeRequest = false
if success and dialogResult and (dialogResult == "Accept" or dialogResult == "right") and
not mockState.active then
...
Modules.RouterClient.get_event('TradeAPI/TradeRequestReceived')
...
if mockState.active or mockState.tradeRequestBlocked then
pcall(function()
Modules.RouterClient.get('TradeAPI/AcceptOrDeclineTradeRequest'):InvokeServer(requesti
ngPlayer, false)
end)
table.insert(mockState.blockedTradeRequests, { player = requestingPlayer,
timestamp = tick() })
return
end
...
if string.find(t, 'has expired') or (string.find(t, 'trade request') and string.find(t,
'expired')) then
return 'Okay'
end
end
if dialogData and dialogData.header and type(dialogData.header) == 'table' and
dialogData.header.text == 'Verified Friend' then
return mockState.originalDialogFunction(self, dialogData)
end
if mockState.active and dialogData and dialogData.dialog_type == 'ItemPreviewDialog'
and dialogData.item and dialogData.text then
local isTradeRequest = string.find(dialogData.text, 'trade request') or
string.find(dialogData.text, 'Trade request')
...
if item.category == 'pets' and Modules.InventoryDB.pets and
Modules.InventoryDB.pets[item.kind] then
...
dialogData.text = ('Add suggestion for %s\'s
%s%s?'):format(CONFIG.PARTNER_NAME, petDisplayName, tagStr)
dialogData.right = 'Suggest'
local result = mockState.originalDialogFunction(self, dialogData)
if result == 'Suggest' then
pcall(function()
...
if success then
print('[ProfileSuggest] Added pet to offer:', petDisplayName .. tagStr)
else
if Apps.HintApp then
Apps.HintApp:hint({ text = msg or 'Failed to add pet', length = 3,
overridable = true, yields = false })
end
end
end
return 'Cancel'
...
if mockState.active and dialogData and dialogData.dialog_type == 'ItemPreviewDialog'
and dialogData.item and dialogData.text then
local isSuggestDialog = string.find(dialogData.text, 'Add suggestion for')
...
task.spawn(function() task.wait(0.5) mockState._profileSuggestHandled = false
end)
end
return 'Cancel'
end
...
local playerName = string.match(dialogData.text, "(.+) sent you a trade
request")
if playerName then
local player = Services.Players:FindFirstChild(playerName)
if player then
pcall(function()
Modules.RouterClient.get('TradeAPI/AcceptOrDeclineTradeRequest'):InvokeServer(player,
false)
end)
table.insert(mockState.blockedTradeRequests, { player = player,
timestamp = tick() })
end
end
...
if (mockState.active or mockState.tradeRequestBlocked) and not
mockState.isMockTradeDialog then
if dialogData and dialogData.text then
...
task.wait(5)
pcall(function()
if Apps.DialogApp and mockState.hookedDialogFunction and Apps.DialogApp.dialog
~= mockState.hookedDialogFunction then
mockState.originalDialogFunction = Apps.DialogApp.dialog
Apps.DialogApp.dialog = mockState.hookedDialogFunction
print("[DialogHook] Re-applied dialog hook (was overwritten)")
end
end)
end
end)
...
if Apps.PlayerProfileApp and
Apps.PlayerProfileApp.open_player_profile_for_user_id then
...
local success, userId = pcall(function() return
Services.Players:GetUserIdFromNameAsync(username) end)
...
local trueNeonPart = petRigs.get(petModelInstance).get_geo_part(petModelInstance,
neonPart)
...
trueNeonPart.Color = Color3.fromHSV(h, math.min(s * 1.3, 1), math.min(v * 1.4,
1))
else
...
if track.Animation.AnimationId:find('PlayerRidingPet') or
track.Animation.AnimationId:find('507766666') then isRiding = true break end
end
...
petData.ridingAnim =
animator:LoadAnimation(Modules.animationManager.get_track('PlayerRidingPet'))
...
if petData.wrapper.mega_neon then applyMegaNeonEffects(petData.model,
petData.wrapper.pet_id)
elseif petData.wrapper.neon then applyNeonEffects(petData.model,
petData.wrapper.pet_id) end
end)
end
end
end
...
return setmetatable({
Name = partnerName, DisplayName = partnerName, UserId = partnerId, Character =
fakeCharacter,
}, {
__index = function(t, k)
if k == 'Parent' then return Services.Players end
if k == 'IsA' then return function(self, className) return className == 'Player' end
end
...
while checkPart do
if checkPart:GetAttribute('IsFakePet') == true and checkPart.Parent then return
end
...
function CreateFakePlayerCharacterFromPARTNER_NAME(partner_name, partner_id,
pros_fake_pet, pet_flags)
...
character:SetPrimaryPartCFrame(playerCharacter.HumanoidRootPart.CFrame *
...
local ridingAnim =
character.Humanoid.Animator:LoadAnimation(Modules.animationManager.get_track('Player
RidingPet'))
...
local petWrapper = {
char = petModel, mega_neon = pet_flags and pet_flags.M or false, neon =
pet_flags and pet_flags.N or false,
player = fakePetOwner, entity_controller = fakePetOwner, controller =
fakePetOwner, rp_name = '',
pet_trick_level = math.random(1, 5), pet_unique =
Services.HttpService:GenerateGUID(false), pet_id = kind,
location = { full_destination_id = 'housing', destination_id = 'housing',
house_owner = fakePetOwner },
pet_progression = { age = math.random(1, 900000), percentage =
math.random(0.01, 0.99) },
are_colors_sealed = false, is_pet = true,
}
local petState = { char = petModel, player = fakePetOwner, store_key =
'pet_state_managers', is_sitting = false, chars_connected_to_me = {}, states = { { id =
'PetBeingRidden' } } }
...
wrapper = petWrapper, state = petState, model = petModel, character =
character,
hasRidingPet = true, owner = fakePetOwner, ridingAnim = ridingAnim, folder =
folder_fake,
})
if not AnimationManager.running then AnimationManager:Start() end
petCreated = true
print('✓ Registered fake pet with native game systems:', kind, pet_flags and
(pet_flags.M and 'Mega Neon' or pet_flags.N and 'Neon' or 'Regular') or 'Regular')
end)
if not success or not petCreated then
warn('Error creating fake pet (Attempt ' .. retryCount .. '/' .. maxRetries .. '):', err)

folder_fake:Destroy()
for i, folder in ipairs(Spawning.FakePlayers) do if folder == folder_fake then
table.remove(Spawning.FakePlayers, i) break end end
if retryCount < maxRetries then
print('
Retrying fake character creation for ' .. partner_name .. '...')
task.wait(0.5)
return attemptCreate()
else
warn('
Failed to create fake character after ' .. maxRetries .. ' attempts')
return false
end
end
else
...
pcall(function() Modules.UIManager.apps.PlayerNameApp:add_npc_id(character,
partner_name) end)
...
task.spawn(function()
pcall(function()
if Apps.HintApp then Apps.HintApp:hint({ text = 'Trade request sent
to ' .. partner_name, length = 3, overridable = true }) end
end)
end)
...
for _, petData in ipairs(Spawning.FakePetRegistry) do
if petData and petData.model and petData.model.Parent then
enableNoclip(petData.model) end
...
​
{ class = "GuiObject", apply = function(n) n.Visible = false;
n.BackgroundTransparency = 1 end },
​
...
​
return overlay ~= nil and overlay:FindFirstChild(SilentBlockConfig.modalName, true)
~= nil
end
...
​
btn =
modal.BlockingModalContainerWrapper.BlockingModal.AlertModal.AlertContents.Footer.Butt
ons["3"]
​
​
end)
...
​
​
if label and label:IsA("TextLabel") and label.Text ==
"Block" then
​
​
​
...
​
​
pcall(function() if firesignal then firesignal(btn.MouseButton1Click) end
end)
​
​
​
...
run = function(btn)
​
pcall(function() SilentBlockServices.GuiService.SelectedObject = btn
​
task.wait()
​
pcall(function()
...
​
local playerName = (typeof(Selected) == "Instance" and Selected.Name) or
tostring(Selected)
​
print("[block] >>> BlockPlayer: " .. playerName)
​
...
​
​
local inner = d.DescendantAdded:Connect(function()
silentHide(d) end)
...
​
​
for _, c in ipairs(preWatchers) do pcall(function() c:Disconnect() end)
...
​
​
print(("[block] modal dismissed on attempt %d via %s
for %s"):format(attempts, strategy.name, playerName))
​
​
​
​
...
local TradeRemote = Services.ReplicatedStorage:FindFirstChild('Remotes') and
Services.ReplicatedStorage.Remotes:FindFirstChild('TradeAPI') and
Services.ReplicatedStorage.Remotes.TradeAPI:FindFirstChild('SendTradeRequest')
if TradeRemote then
...
Apps.HintApp:hint({ text = 'Trade request sent to ' .. player.Name, length = 3,
overridable = true })
elseif Apps.HintApp then
Apps.HintApp:hint({ text = 'Could not send trade request to ' .. player.Name, length
= 3, overridable = true })
end
end)
else
if Apps.HintApp then
Apps.HintApp:hint({ text = 'Player ' .. player.Name .. ' not found in server', length = 3,
overridable = true })
end
end
end
...
-- drag handle (invisible button over title)
UI.dragHandle = Instance.new('TextButton')
UI.dragHandle.Size = UDim2.new(1, 0, 0, 26)
UI.dragHandle.Position = UDim2.new(0, 0, 0, 0)
UI.dragHandle.BackgroundTransparency = 1
UI.dragHandle.Text = ''
UI.dragHandle.AutoButtonColor = false
UI.dragHandle.ZIndex = 5
UI.dragHandle.Parent = UI.mainFrame
do
...
if UIState.activeTabPulseTween then UIState.activeTabPulseTween:Cancel()
UIState.activeTabPulseTween = nil end

UIState.currentTab = tabName
for name, data in pairs(UIState.tabButtons) do
local isActive = name == tabName
Services.TweenService:Create(data.button, TweenInfo.new(0.25,
Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
BackgroundColor3 = isActive and Color3.fromRGB(50, 50, 60) or
Color3.fromRGB(40, 40, 50)
}):Play()
local targetColor = isActive and Color3.fromRGB(100, 100, 255) or Color3.fromRGB(80,
80, 80)
Services.TweenService:Create(data.stroke, TweenInfo.new(0.25,
Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
Color = targetColor, Thickness = isActive and 1.2 or 0.8
}):Play()
if isActive then
UIState.activeTabPulseTween = Services.TweenService:Create(data.stroke,
...
tabButton.BackgroundColor3 = i == 1 and Color3.fromRGB(50, 50, 60) or
Color3.fromRGB(40, 40, 50)
...
tabStroke.Color = i == 1 and Color3.fromRGB(100, 100, 255) or Color3.fromRGB(80, 80,
80)
...
UIState.pulsationTweens[box] = Services.TweenService:Create(stroke,
TweenInfo.new(0.8, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true), {
Color = Color3.fromRGB(100, 100, 255):Lerp(Color3.fromRGB(150, 150, 255), 0.5),
Thickness = 1.2, Transparency = 0.2
})
UIState.pulsationTweens[box]:Play()
end)
box.FocusLost:Connect(function()
if UIState.pulsationTweens[box] then UIState.pulsationTweens[box]:Cancel()
UIState.pulsationTweens[box] = nil end
Services.TweenService:Create(stroke, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
Color = Color3.fromRGB(100, 100, 100), Thickness = 0.8, Transparency = 0.5 }):Play()
end)
return box, stroke, heading
end
partnerBox, partnerStroke = createSettingRow('Partner Username',
CONFIG.PARTNER_NAME, UI.controlFrame)
UI.acceptBox = createSettingRow('Accept Delay (s)', CONFIG.AUTO_ACCEPT_DELAY,
UI.controlFrame)
UI.confirmBox = createSettingRow('Confirm Delay (s)', CONFIG.AUTO_CONFIRM_DELAY,
UI.controlFrame)
spectatorBox = createSettingRow('Spectator Count', CONFIG.SPECTATOR_COUNT,
UI.controlFrame)
UI.requestDelayBox = createSettingRow('Request Delay (s)',
CONFIG.TRADE_REQUEST_DELAY, UI.controlFrame)
partnerBox.FocusLost:Connect(function() updatePartnerFromUsername(partnerBox.Text)
end)
UI.acceptBox.FocusLost:Connect(function()

local value = tonumber(UI.acceptBox.Text)
if value and value >= 0 then CONFIG.AUTO_ACCEPT_DELAY = value else
UI.acceptBox.Text = tostring(CONFIG.AUTO_ACCEPT_DELAY) end
end)
UI.confirmBox.FocusLost:Connect(function()
local value = tonumber(UI.confirmBox.Text)
if value and value >= 0 then CONFIG.AUTO_CONFIRM_DELAY = value else
UI.confirmBox.Text = tostring(CONFIG.AUTO_CONFIRM_DELAY) end
end)
...
if Apps.TradeApp.refresh_all then Apps.TradeApp:refresh_all() FriendHighlight(true)
end
end
else
...
if value and value >= 0 then CONFIG.TRADE_REQUEST_DELAY = value else
UI.requestDelayBox.Text = tostring(CONFIG.TRADE_REQUEST_DELAY) end
end)
...
startAutoSpectate()
if Apps.HintApp then
Apps.HintApp:hint({ text = 'Auto Spectate ON! Range: ' ..
(ORIGINAL_SPECTATOR_COUNT + CONFIG.SPECTATOR_VARIATION_MIN) .. '-' ..
(ORIGINAL_SPECTATOR_COUNT + CONFIG.SPECTATOR_VARIATION_MAX), length =
3, overridable = true })
end
else
UI.autoSpectateButton.Text = '
...
createButton('Add Random Item', Color3.fromRGB(100, 50, 150), Color3.fromRGB(200,
100, 255), UI.controlFrame, function()
if mockState.active and mockState.trade then
addPetToPartnerOffer(getRandomHighValuePet(), generateRandomPetProperties())
end
end)
createSpacer(UI.controlFrame)
createButton('Clear Trade', Color3.fromRGB(150, 50, 50), Color3.fromRGB(255, 100, 100),
UI.controlFrame, function()
if mockState.active and mockState.trade then
...
createSpacer(UI.controlFrame)
createButton('Start Trade', Color3.fromRGB(50, 80, 60), Color3.fromRGB(0, 255, 100),
UI.controlFrame, function()
...
createButton('Block Player', Color3.fromRGB(150, 50, 50), Color3.fromRGB(255, 100, 100),
UI.controlFrame, function()
...
mockState.trade.offer_version = mockState.trade.offer_version + 1
Apps.TradeApp:_overwrite_local_trade_state(mockState.trade)
if mockState.trade.sender_offer.confirmed and not mockState.tradeCompleting
then
mockState.tradeCompleting = true
if Apps.TradeApp._set_confirmation_arrow_rotating then
Apps.TradeApp:_set_confirmation_arrow_rotating(true) end
...
task.wait(0.1)
showBlockedTradeRequests()
if Apps.HintApp then Apps.HintApp:hint({ text = 'The trade was successful!',
length = 5, overridable = true }) end
if Apps.TradeHistoryApp and Modules.UIManager.is_visible('TradeHistoryApp')
then Apps.TradeHistoryApp:_refresh() end
end
end
...
createButton('Make Partner Accept', Color3.fromRGB(50, 150, 50), Color3.fromRGB(100,
255, 100), UI.controlFrame, makePartnerAccept)
createSpacer(UI.controlFrame)
UI.noclipButton, UI.noclipStroke = createButton('Toggle Noclip: ON', Color3.fromRGB(80, 80,
180), Color3.fromRGB(100, 100, 255), UI.controlFrame, function()
...
createSpacer(UI.controlFrame)
createButton('Make Partner Unaccept', Color3.fromRGB(150, 50, 50), Color3.fromRGB(255,
100, 100), UI.controlFrame, makePartnerUnaccept)
createSpacer(UI.controlFrame)
...
UI.petTypeButtons = {}
local petTypes = { { name = 'regular', label = 'Reg', pos = 0.4 }, { name = 'neon', label =
'Neon', pos = 0.6 }, { name = 'mega', label = 'Mega', pos = 0.8 } }
...
btn.Text = pt.label
btn.BackgroundColor3 = pt.name == 'regular' and Color3.fromRGB(50, 150, 50) or
...
b.BackgroundColor3 = name == pt.name and Color3.fromRGB(50, 150, 50) or
Color3.fromRGB(60, 60, 70)
end
end)
end
createButton('Spawn fake player', Color3.fromRGB(65, 50, 150), Color3.fromRGB(74, 207,
255), UI.controlFrame, function()
local petData, petFlags = nil, nil
if CONFIG.SPAWN_FAKE_PLAYER_WITH_RANDOM_PET then
local highValuePet = getRandomHighValuePet()
petFlags = { M = currentFakePetType == 'mega', N = currentFakePetType == 'neon', F
= true, R = true }
petData = { kind = GetKindPet(highValuePet) }
end
CreateFakePlayerCharacterFromPARTNER_NAME(CONFIG.PARTNER_NAME,
Services.Players:GetUserIdFromNameAsync(CONFIG.PARTNER_NAME), petData,
petFlags)
end)
createSpacer(UI.controlFrame)
...
CONFIG.SPAWN_FAKE_PLAYER_WITH_RANDOM_PET = not
CONFIG.SPAWN_FAKE_PLAYER_WITH_RANDOM_PET
UI.spawnWithPetsButton.Text = 'Spawn with random pet: ' ..
...
if petWrappers[i].pet_unique == petData.wrapper.pet_unique then
table.remove(petWrappers, i) end
end
return petWrappers
end)
end)
...
for _, folder in pairs(Spawning.FakePlayers) do if folder and folder.Parent then
folder:Destroy() end end
Spawning.FakePlayers = {}
Spawning.FakePetRegistry = {}
fakePlayerIds = {}
_G.fakePlayerIds = {}
print('
All fake players and pets deleted successfully')
end)
end)
createSpacer(UI.controlFrame)
UI.removePetsButton, UI.removePetsStroke = createButton('Remove Partner Pets: OFF',
Color3.fromRGB(150, 50, 50), Color3.fromRGB(255, 100, 100), UI.controlFrame, function()
mockState.removePartnerPetsOnConfirm = not mockState.removePartnerPetsOnConfirm
CONFIG.REMOVE_PARTNER_PETS_ON_CONFIRM =
mockState.removePartnerPetsOnConfirm
...
UI.richestHeading.Text = '
Top 35 Richest Services.Players (Auto-Refresh)'
...
Services.TweenService:Create(tradeButton, TweenInfo.new(0.15), { BackgroundColor3
= Color3.fromRGB(70, 160, 120) }):Play()
end)
tradeButton.MouseLeave:Connect(function()
Services.TweenService:Create(tradeButton, TweenInfo.new(0.15), { BackgroundColor3
= Color3.fromRGB(50, 130, 100) }):Play()
end)
...
if Apps.HintApp then
Apps.HintApp:hint({ text = playerData.playerName .. ' is not in this server', length =
3, overridable = true })
end
end
end)
...
Services.TweenService:Create(profileButton, TweenInfo.new(0.15), {
BackgroundColor3 = Color3.fromRGB(130, 90, 180) }):Play()
end)
profileButton.MouseLeave:Connect(function()
Services.TweenService:Create(profileButton, TweenInfo.new(0.15), {
BackgroundColor3 = Color3.fromRGB(100, 70, 150) }):Play()
end)
...
petLabel.TextSize = 9
petLabel.TextColor3 = pet.isMega and Color3.fromRGB(170, 100, 255) or
(pet.isNeon and Color3.fromRGB(100, 255, 150) or Color3.fromRGB(200, 200, 200))
...
if not forceRefresh and (currentTime - RefreshState.lastRefreshTime) <
RefreshState.REFRESH_COOLDOWN then
return
end
...
local playerData = { playerName = player.Name, totalValue = totalValue, pets =
allPets, player = player }
RefreshState.playerCache[player.Name] = { totalValue = totalValue, pets = allPets,
player = player, lastUpdated = tick() }
...
local rankColors = { [1] = Color3.fromRGB(255, 215, 0), [2] = Color3.fromRGB(192,
192, 192), [3] = Color3.fromRGB(205, 127, 50) }
for i = 1, displayCount do

⏳

local data = UIState.richestData[i]
local existingContainer = UI.richestListFrame:FindFirstChild('RichestPlayer_' ..
data.playerName)
...
local data = UIState.richestData[i]
local container = UI.richestListFrame:FindFirstChild('RichestPlayer_' ..
data.playerName)
if container then container:Destroy() end
end
updateCanvasSize()
if forceRefresh and Apps.HintApp then
Apps.HintApp:hint({ text = 'Updated ' .. #UIState.richestData .. ' players!', length = 2,
overridable = true })
end
...
local rankColors = { [1] = Color3.fromRGB(255, 215, 0), [2] =
Color3.fromRGB(192, 192, 192), [3] = Color3.fromRGB(205, 127, 50) }
for i, data in ipairs(UIState.richestData) do
if i <= 35 then
local container = UI.richestListFrame:FindFirstChild('RichestPlayer_' ..
data.playerName)
...
if rankBadge and rankBadge.Size == UDim2.new(0, 20, 0, 20) then
rankBadge.Text = tostring(i)
rankBadge.BackgroundColor3 = rankColors[i] or Color3.fromRGB(80,
80, 100)
end
end
...
if rankBadge and rankBadge.Size == UDim2.new(0, 20, 0, 20) then
rankBadge.Text = tostring(i)
rankBadge.BackgroundColor3 = rankColors[i] or Color3.fromRGB(80, 80,
100)
end
end
end
...
button.BackgroundColor3 = isSelected and Color3.fromRGB(50, 80, 100) or
Color3.fromRGB(40, 40, 50)
...
buttonStroke.Color = isSelected and Color3.fromRGB(100, 150, 255) or
...
checkBox.BackgroundColor3 = isSelected and Color3.fromRGB(50, 150, 50) or
Color3.fromRGB(60, 60, 70)
...
checkBoxStroke.Color = isSelected and Color3.fromRGB(100, 255, 100) or
Color3.fromRGB(80, 80, 80)
...
checkBox.BackgroundColor3 = isNowSelected and Color3.fromRGB(50, 150, 50) or
Color3.fromRGB(60, 60, 70)
checkBoxStroke.Color = isNowSelected and Color3.fromRGB(100, 255, 100) or
Color3.fromRGB(80, 80, 80)
checkMark.Visible = isNowSelected

button.BackgroundColor3 = isNowSelected and Color3.fromRGB(50, 80, 100) or
Color3.fromRGB(40, 40, 50)
buttonStroke.Color = isNowSelected and Color3.fromRGB(100, 150, 255) or
Color3.fromRGB(80, 80, 80)
else
...
pcall(function()
local tradePart =
Services.Players.LocalPlayer.PlayerGui.TradeApp.Frame.NegotiationFrame.Header.Partner
Frame.NameLabel.Text
for _, player in ipairs(Services.Players:GetPlayers()) do
...
UIState.selectedPlayers = {}
refreshPlayerList()
if Apps.HintApp then Apps.HintApp:hint({ text = 'Blocked ' .. count .. ' player(s)', length = 3,
overridable = true }) end
end)
refreshPlayerList()
...
Services.TweenService:Create(buttonStroke, TweenInfo.new(0.3,
Enum.EasingStyle.Quad), { Color = Color3.fromRGB(0, 255, 0), Thickness = 1.2,
Transparency = 0.2 }):Play()
else
prefixButton.BackgroundColor3 = Color3.fromRGB(60, 60, 70)

Services.TweenService:Create(buttonStroke, TweenInfo.new(0.3,
Enum.EasingStyle.Quad), { Color = prefixColors[prefix], Thickness = 1.0, Transparency = 0.5
}):Play()
end
end)
end
...
if value and value >= 0 then CONFIG.ADD_PET_REQUEST_DELAY = value else
UI.requestAddPetBox.Text = tostring(CONFIG.ADD_PET_REQUEST_DELAY) end
end)
...
if petName and petName ~= '' then addPetToPartnerOffer(petName,
petSpawnState.activeFlags) end
end)
...
Services.TweenService:Create(button, TweenInfo.new(0.2), { BackgroundColor3 =
Color3.fromRGB(70, 65, 95) }):Play()
Services.TweenService:Create(buttonStroke, TweenInfo.new(0.2), { Color =
Color3.fromRGB(255, 220, 80), Transparency = 0 }):Play()
end)
button.MouseLeave:Connect(function()
Services.TweenService:Create(button, TweenInfo.new(0.2), { BackgroundColor3 =
Color3.fromRGB(55, 50, 75) }):Play()
Services.TweenService:Create(buttonStroke, TweenInfo.new(0.2), { Color =
Color3.fromRGB(255, 200, 50), Transparency = 0.2 }):Play()
end)
button.MouseButton1Click:Connect(function()
UI.petNameBox.Text = petName

Services.TweenService:Create(UI.petNameStroke, TweenInfo.new(0.3,
Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { Color = Color3.fromRGB(255, 200,
50), Thickness = 1.5 }):Play()
task.wait(0.5)
Services.TweenService:Create(UI.petNameStroke, TweenInfo.new(0.3,
Enum.EasingStyle.Quint, Enum.EasingDirection.Out), { Color = Color3.fromRGB(100, 100,
100), Thickness = 0.8 }):Play()
end)
end
...
buttonStroke.Parent = button
button.MouseEnter:Connect(function()
Services.TweenService:Create(button, TweenInfo.new(0.15), { BackgroundColor3 =
Color3.fromRGB(70, 65, 95) }):Play()
Services.TweenService:Create(buttonStroke, TweenInfo.new(0.15), { Color =
Color3.fromRGB(255, 220, 80), Transparency = 0 }):Play()
...
UI.chatListFrame.CanvasSize = UDim2.new(0, 0, 0, (#CONFIG.CHAT_MESSAGES * 27) +
8)
...
Services.TweenService:Create(btn, TweenInfo.new(0.15), { BackgroundColor3 =
Color3.fromRGB(90, 85, 120) }):Play()
end
end)
...
if old then old.Text = UIState.keybinds[UIState.waitingForKeybind].Name;
old.BackgroundColor3 = Color3.fromRGB(70, 65, 95) end
end
...
valueLabel.Text = string.format('%dh %dm %ds', math.floor(uptime/3600),
math.floor((uptime%3600)/60), math.floor(uptime%60))
task.wait(1)
end
end)
end
...
if Apps.HintApp then Apps.HintApp:hint({ text = 'GUI Scale: ' .. string.format('%.0f%%',
SetsUI.currentScale * 100), length = 1, overridable = true }) end
end)
...
smallBtn.MouseEnter:Connect(function() Services.TweenService:Create(smallBtn,
TweenInfo.new(0.15), { BackgroundColor3 = Color3.fromRGB(100, 80, 150) }):Play() end)
smallBtn.MouseLeave:Connect(function() Services.TweenService:Create(smallBtn,
TweenInfo.new(0.15), { BackgroundColor3 = Color3.fromRGB(80, 60, 120) }):Play() end)
bigBtn.MouseEnter:Connect(function() Services.TweenService:Create(bigBtn,
TweenInfo.new(0.15), { BackgroundColor3 = Color3.fromRGB(80, 150, 100) }):Play() end)
bigBtn.MouseLeave:Connect(function() Services.TweenService:Create(bigBtn,
TweenInfo.new(0.15), { BackgroundColor3 = Color3.fromRGB(60, 120, 80) }):Play() end)
end
...
local colors = { M = {Color3.fromRGB(170,0,255), Color3.fromRGB(80,60,100)}, N =
{Color3.fromRGB(255,215,0), Color3.fromRGB(80,60,100)}, F =
{Color3.fromRGB(0,200,255), Color3.fromRGB(80,60,100)}, R =
{Color3.fromRGB(0,255,100), Color3.fromRGB(80,60,100)} }
local function fmtVal(v)
if not v or v == 0 then return '?' end
return v >= 1e9 and string.format('%.2fB',v/1e9) or (v >= 1e6 and
string.format('%.2fM',v/1e6) or (v >= 1e3 and string.format('%.1fK',v/1e3) or tostring(v)))
end
Instance.new('Frame', UI.setsFrame).Size = UDim2.new(1,0,0,10);
UI.setsFrame:GetChildren()[#UI.setsFrame:GetChildren()].BackgroundTransparency = 1;
UI.setsFrame:GetChildren()[#UI.setsFrame:GetChildren()].LayoutOrder = 19
local h = Instance.new('TextLabel', UI.setsFrame)
h.Size, h.BackgroundTransparency, h.Text, h.Font, h.TextSize, h.TextColor3,
h.TextXAlignment, h.LayoutOrder = UDim2.new(1,0,0,18), 1, '
Pet Value Calculator',
Enum.Font.GothamBold, 12, Color3.fromRGB(255,200,50), Enum.TextXAlignment.Center,
20
local ir = Instance.new('Frame', UI.setsFrame)
ir.Size, ir.BackgroundColor3, ir.BackgroundTransparency, ir.LayoutOrder =
UDim2.new(1,0,0,30), Color3.fromRGB(55,50,75), 0.1, 21
Instance.new('UICorner', ir).CornerRadius = UDim.new(0,6)
local irs = Instance.new('UIStroke', ir); irs.Color, irs.Thickness, irs.Transparency =
Color3.fromRGB(255,200,50), 1.5, 0.2
PVC.input = Instance.new('TextBox', ir)
PVC.input.Size, PVC.input.Position, PVC.input.BackgroundTransparency, PVC.input.Text,
PVC.input.PlaceholderText = UDim2.new(1,-16,1,-6), UDim2.new(0,8,0,3), 1, '', 'Enter pet
name...'
PVC.input.Font, PVC.input.TextSize, PVC.input.TextColor3, PVC.input.PlaceholderColor3,
PVC.input.TextXAlignment, PVC.input.ClearTextOnFocus = Enum.Font.GothamMedium, 11,
Color3.fromRGB(255,255,255), Color3.fromRGB(150,150,160), Enum.TextXAlignment.Left,
false
...
b.Size, b.Position, b.BackgroundColor3, b.Text, b.Font, b.TextSize, b.TextColor3 =
UDim2.new(0.24,-4,1,0), UDim2.new((i-1)*0.25,2,0,0), colors[p][2], p,
Enum.Font.GothamBold, 12, Color3.fromRGB(255,255,255)
Instance.new('UICorner', b).CornerRadius = UDim.new(0,4)
PVC.btns[p] = b
b.MouseButton1Click:Connect(function()
if p == 'M' then PVC.state.M = not PVC.state.M; if PVC.state.M then PVC.state.N =
false end
elseif p == 'N' then PVC.state.N = not PVC.state.N; if PVC.state.N then PVC.state.M
= false end
else PVC.state[p] = not PVC.state[p] end

💎

for k, v in pairs(PVC.btns) do v.BackgroundColor3 = PVC.state[k] and colors[k][1] or
colors[k][2] end
end)
end
local cb = Instance.new('TextButton', UI.setsFrame)
cb.Size, cb.BackgroundColor3, cb.Text, cb.Font, cb.TextSize, cb.TextColor3,
cb.LayoutOrder = UDim2.new(1,0,0,32), Color3.fromRGB(80,160,80), '
Calculate Value',
Enum.Font.GothamBold, 12, Color3.fromRGB(255,255,255), 23
Instance.new('UICorner', cb).CornerRadius = UDim.new(0,6)
local cbs = Instance.new('UIStroke', cb); cbs.Color, cbs.Thickness, cbs.Transparency =
Color3.fromRGB(255,200,50), 1.5, 0.2
PVC.result = Instance.new('TextLabel', UI.setsFrame)
PVC.result.Size, PVC.result.BackgroundColor3, PVC.result.Text, PVC.result.Font,
PVC.result.TextSize, PVC.result.TextColor3, PVC.result.LayoutOrder =
UDim2.new(1,0,0,36), Color3.fromRGB(40,35,55), 'Value: --', Enum.Font.GothamBold, 14,
Color3.fromRGB(100,255,150), 24
Instance.new('UICorner', PVC.result).CornerRadius = UDim.new(0,6)
local rs = Instance.new('UIStroke', PVC.result); rs.Color, rs.Thickness, rs.Transparency =
Color3.fromRGB(255,200,50), 1.5, 0.2
cb.MouseButton1Click:Connect(function()
local sn = PVC.input.Text:lower():gsub('^%s+',''):gsub('%s+$','')
if sn == '' then PVC.result.Text, PVC.result.TextColor3 = 'Enter a pet name!',
Color3.fromRGB(255,100,100) return end
local fp, fk = nil, nil
for k, pet in pairs(PetData.petsByName) do if k:lower():gsub('%s+','') == sn or
k:lower():gsub('%s+',''):find(sn,1,true) then fp, fk = pet, k break end end
if not fp then PVC.result.Text, PVC.result.TextColor3 = 'Pet not found!',
Color3.fromRGB(255,100,100) return end
...
local fv = fmtVal(v)
local ps = (PVC.state.M and 'M' or '')..(PVC.state.N and 'N' or '')..(PVC.state.F and 'F' or
'')..(PVC.state.R and 'R' or '')
if ps == '' then ps = 'NR' end
PVC.result.Text, PVC.result.TextColor3 = fk..' ('..ps..'): '..fv,
Color3.fromRGB(100,255,150)
end)
cb.MouseEnter:Connect(function() Services.TweenService:Create(cb,
TweenInfo.new(0.15), {BackgroundColor3=Color3.fromRGB(100,180,100)}):Play() end)
cb.MouseLeave:Connect(function() Services.TweenService:Create(cb,
TweenInfo.new(0.15), {BackgroundColor3=Color3.fromRGB(80,160,80)}):Play() end)
end
...
local item = items[id]
if not item then warn("Pet ID not found: "..id) return nil end
set_thread_identity(2)
local new_pet = {
unique = uniqueId, category = "pets", id = id, kind = item.kind,

newness_order = math.random(1, 900000), properties = properties or {}
}
...
updateData("pet_char_wrappers", function(petWrappers)
local index = findIndex(petWrappers, function(wrapper) return wrapper.pet_unique ==
uniqueId end)
...
for _, descendant in
pairs(Services.Players.LocalPlayer.Character:GetDescendants()) do
...
SC.currentMountTrack =
player.Character.Humanoid.Animator:LoadAnimation(Modules.animationManager.get_track("
PlayerRidingPet"))
...
SC.equippedPet = item
addPetWrapper({
char = petModel, mega_neon = item.properties.mega_neon, neon =
item.properties.neon,
player = Services.Players.LocalPlayer, entity_controller =
...
pet_id = item.id,
location = { full_destination_id = "housing", destination_id = "housing",
house_owner = Services.Players.LocalPlayer },
pet_progression = { age = math.random(1, 900000), percentage =
math.random(0.01, 0.99) },
are_colors_sealed = false, is_pet = true
})
addPetState({
char = petModel, player = Services.Players.LocalPlayer, store_key =
"pet_state_managers",
...
s.Thickness = 1.5; s.Transparency = 0.1; s.Parent = petTab
local ts = Instance.new("UIStroke"); ts.ApplyStrokeMode =
Enum.ApplyStrokeMode.Contextual; ts.Color = Color3.new(0,0,0); ts.Thickness = 1.5;
ts.Parent = petTab
end
...
do
local s = Instance.new("UIStroke"); s.Color = Color3.fromRGB(255,255,255);
s.Thickness = 1.5; s.Transparency = 0.1; s.Parent = toyTab
local ts = Instance.new("UIStroke"); ts.ApplyStrokeMode =
Enum.ApplyStrokeMode.Contextual; ts.Color = Color3.new(0,0,0); ts.Thickness = 1.5;
ts.Parent = toyTab
end
local petContent = Instance.new("Frame")
petContent.Size = UDim2.new(1, 0, 0, 700)
...
do
local ts = Instance.new("UIStroke"); ts.ApplyStrokeMode =
Enum.ApplyStrokeMode.Contextual; ts.Color = Color3.new(0,0,0); ts.Thickness = 1.2;
ts.Parent = UI.petNameBox
end
...
currentColorTween = Services.TweenService:Create(boxGlow, TweenInfo.new(0.8,
Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color = targetColor})
...
UI.petNameBox.CursorPosition = math.max(1, math.min(lastCursorPosition +
addedChars, #newText + 1))
return
end
...
prefixButton.Position = UDim2.new(toggleStartX + (toggleButtonWidth + toggleSpacing)
* (i - 1), 0, 0, 50)
prefixButton.Text = prefix
prefixButton.BackgroundColor3 = Color3.fromRGB(60, 60, 70)
prefixButton.BackgroundTransparency = 0.2
...
local origStroke = { Color = SpawnerState.baseColors[prefix], Thickness = 2,
Transparency = 0.5 }
prefixButton.MouseButton1Click:Connect(function()
...
prefixButton.BackgroundColor3 = Color3.fromRGB(100, 100, 100)
Services.TweenService:Create(btnStroke, TweenInfo.new(0.3,
...
Services.TweenService:Create(btnStroke, TweenInfo.new(0.3,
Enum.EasingStyle.Quad), {
Color = origStroke.Color, Thickness = origStroke.Thickness, Transparency =
origStroke.Transparency
...
local animationSystem = { pulsePhase = 0, pulseSpeed = 2, baseThickness = 1.2,
maxThickness = 3, activeColors = nil, active = false }
...
r = r + (color.R * brightness); g = g + (color.G * brightness); b = b + (color.B *
brightness)
end
...
local labels = {}
if activeFlags["M"] then table.insert(labels, {"Mega Neon",
SpawnerState.baseColors.M}); table.insert(activeColors, SpawnerState.baseColors.M);
hasFlags = true end
if activeFlags["N"] then table.insert(labels, {"Neon", SpawnerState.baseColors.N});
table.insert(activeColors, SpawnerState.baseColors.N); hasFlags = true end
if activeFlags["F"] then table.insert(labels, {"Fly", SpawnerState.baseColors.F});
table.insert(activeColors, SpawnerState.baseColors.F); hasFlags = true end
if activeFlags["R"] then table.insert(labels, {"Ride", SpawnerState.baseColors.R});
table.insert(activeColors, SpawnerState.baseColors.R); hasFlags = true end
for _, labelData in ipairs(labels) do createTextLabel(labelData[1], labelData[2]).Parent =
infoTextContainer end
if hasFlags then
...
local highTierActiveAnimation = { endTime = 0, strokeTween = nil, resetThread = nil,
intensity = 1.0 }
...
Services.TweenService:Create(highTierStroke, TweenInfo.new(0.2), { Thickness = 2,
...
Services.TweenService:Create(highTierStroke, TweenInfo.new(0.2), { Thickness =
highTierOriginalProperties.StrokeThickness, Transparency =
highTierOriginalProperties.StrokeTransparency }):Play()
end
end)
...
if isExtension then
highTierActiveAnimation.intensity = math.min(highTierActiveAnimation.intensity +
0.3, 1.5)
else
highTierActiveAnimation.intensity = 1.0
end
if highTierActiveAnimation.strokeTween then
highTierActiveAnimation.strokeTween:Cancel() end
if highTierActiveAnimation.resetThread then
coroutine.close(highTierActiveAnimation.resetThread) end
...
neon = (not SpawnerState.activeFlags['M'] and SpawnerState.activeFlags['N'])
or nil,
...
game.StarterGui:SetCore("SendNotification", { Title = "High Tier Pets Spawned!",
Text = "All high tier pets have been spawned!", Duration = 5 })
else
game.StarterGui:SetCore("SendNotification", { Title = "Error", Text = "Failed to spawn
high tier pets!", Duration = 3 })
end
...
if isExtension then
highTierActiveAnimation.strokeTween =
Services.TweenService:Create(highTierStroke, TweenInfo.new(0.2,
Enum.EasingStyle.Quad), { Thickness = 2.5 * highTierActiveAnimation.intensity,
...
Services.TweenService:Create(highTierStroke, TweenInfo.new(0.5,
Enum.EasingStyle.Quad), { Color = highTierOriginalProperties.StrokeColor, Thickness =
highTierOriginalProperties.StrokeThickness, Transparency =
highTierOriginalProperties.StrokeTransparency }):Play()
end
end)
...
local activeAnimation = { endTime = 0, strokeTween = nil, resetThread = nil, intensity =
1.0, lastSuccess = false }
startButton.MouseEnter:Connect(function()
if activeAnimation.endTime < os.clock() then
startButton.BackgroundColor3 = Color3.fromRGB(0, 130, 230)
Services.TweenService:Create(buttonStroke, TweenInfo.new(0.2), { Thickness = 2,
Transparency = 0.05 }):Play()
end
end)
...
Services.TweenService:Create(buttonStroke, TweenInfo.new(0.2), { Thickness =
originalProperties.StrokeThickness, Transparency = originalProperties.StrokeTransparency
}):Play()
end
end)
...
createPet(petId, props)
spawnSuccess = true
game.StarterGui:SetCore("SendNotification", { Title = "Pet Spawned!", Text =
pet_name .. " has been spawned!", Duration = 5 })
else
game.StarterGui:SetCore("SendNotification", { Title = "Error", Text = "Pet not
found: "..pet_name, Duration = 3 })
end
else
game.StarterGui:SetCore("SendNotification", { Title = "Error", Text = "Please enter a
pet name!", Duration = 3 })
end
...
if isExtension then
activeAnimation.strokeTween = Services.TweenService:Create(buttonStroke,
TweenInfo.new(0.2, Enum.EasingStyle.Quad), { Thickness = 2.5 * activeAnimation.intensity,
...
Services.TweenService:Create(buttonStroke, TweenInfo.new(0.5,
Enum.EasingStyle.Quad), { Color = originalProperties.StrokeColor, Thickness =
originalProperties.StrokeThickness, Transparency = originalProperties.StrokeTransparency
}):Play()
end
end)
...
petContent.Size = UDim2.new(1, 0, 0, 700)
local PROFILE_PAGE_COUNT = 7
local PROFILE_SLOT_COUNT = 4
local function _newSlot()
return { names = "", flags = { F = false, R = false, N = false, M = false }, appliedForm =
nil }
end
local function _pcFormFlagsFromName(formName)
if formName == "MFR" then return { F = true, R = true, N = false, M = true } end
if formName == "NFR" then return { F = true, R = true, N = true, M = false } end
if formName == "FR" then return { F = true, R = true, N = false, M = false } end
return nil
end
local function _newPage()
local slots = {}
for i = 1, PROFILE_SLOT_COUNT do slots[i] = _newSlot() end
return { slots = slots }
end
...
for i = 1, PROFILE_PAGE_COUNT do ProfileCollection.pages[i] = _newPage() end
local pcSection = Instance.new("Frame")
pcSection.Size = UDim2.new(0.9, 0, 0, 470)
pcSection.Position = UDim2.new(0.05, 0, 0, 215)
pcSection.BackgroundTransparency = 1
pcSection.Parent = petContent

local pcHeading = Instance.new("TextLabel")
pcHeading.Size = UDim2.new(1, 0, 0, 16)
pcHeading.BackgroundTransparency = 1
pcHeading.Text = "Profile Collection (Auto-Refresh)"
pcHeading.Font = Enum.Font.FredokaOne
pcHeading.TextSize = 12
pcHeading.TextColor3 = Color3.fromRGB(120, 220, 255)
pcHeading.TextXAlignment = Enum.TextXAlignment.Left
pcHeading.Parent = pcSection
local pcPageTabs = {}
do
local btnW = (1 - 0.01 * (PROFILE_PAGE_COUNT - 1)) / PROFILE_PAGE_COUNT
for i = 1, PROFILE_PAGE_COUNT do
local btn = Instance.new("TextButton")
btn.Size = UDim2.new(btnW, 0, 0, 22)
btn.Position = UDim2.new((i - 1) * (btnW + 0.01), 0, 0, 20)
btn.BackgroundColor3 = (i == 1) and Color3.fromRGB(160, 100, 60) or
...
local btn = Instance.new("TextButton")
btn.Size = UDim2.new(0.24, 0, 0, 22)
btn.Position = UDim2.new((i - 1) * 0.255, 0, 0, 46)
btn.BackgroundColor3 = (i == 1) and Color3.fromRGB(80, 140, 200) or
Color3.fromRGB(50, 50, 60)
btn.BackgroundTransparency = 0.2
btn.Text = "Slot " .. i
btn.Font = Enum.Font.FredokaOne
...
local pcPetBox = Instance.new("TextBox")

pcPetBox.Size = UDim2.new(1, 0, 0, 50)
pcPetBox.Position = UDim2.new(0, 0, 0, 74)
pcPetBox.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
pcPetBox.BackgroundTransparency = 0.2
pcPetBox.Text = ""
pcPetBox.PlaceholderText = "Pets for this page+slot (one per line or comma-separated)"
pcPetBox.Font = Enum.Font.SourceSans
pcPetBox.TextSize = 11
pcPetBox.TextColor3 = Color3.fromRGB(255, 255, 255)
pcPetBox.ClearTextOnFocus = false
pcPetBox.MultiLine = true
pcPetBox.TextXAlignment = Enum.TextXAlignment.Left
pcPetBox.TextYAlignment = Enum.TextYAlignment.Top
pcPetBox.Parent = pcSection
Instance.new("UICorner", pcPetBox).CornerRadius = UDim.new(0, 4)
local function _pcMkLabel(text, x, y, w)
local l = Instance.new("TextLabel")
l.Size = UDim2.new(w, 0, 0, 12)
l.Position = UDim2.new(x, 0, 0, y)
...
local function _pcMkBox(default, x, w, y)
...
_pcMkLabel("Form (this page+slot)", 0, 128, 1)
local pcFlagButtons = {}
local _pcFlagOrder = { "F", "R", "N", "M" }

local _pcFlagColors = {
F = Color3.fromRGB(60, 130, 180),
R = Color3.fromRGB(180, 70, 70),
N = Color3.fromRGB(70, 170, 80),
M = Color3.fromRGB(140, 80, 180),
}
local function _pcSetFlagVisual(key, on)
local f = pcFlagButtons[key]
if not f then return end
if on then
f.button.BackgroundColor3 = _pcFlagColors[key]
f.button.TextColor3 = Color3.fromRGB(255, 255, 255)
f.stroke.Transparency = 0.1
f.stroke.Thickness = 1.8
else
f.button.BackgroundColor3 = Color3.fromRGB(50, 50, 60)
f.button.TextColor3 = Color3.fromRGB(200, 200, 200)
f.stroke.Transparency = 0.6
f.stroke.Thickness = 1.2
end
end
for i, key in ipairs(_pcFlagOrder) do
local btn = Instance.new("TextButton")
btn.Size = UDim2.new(0.22, 0, 0, 22)
btn.Position = UDim2.new((i - 1) * 0.26, 0, 0, 142)
...
Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 4)
local stroke = Instance.new("UIStroke")
stroke.Color = _pcFlagColors[key]
stroke.Thickness = 1.2
stroke.Transparency = 0.6
stroke.Parent = btn
pcFlagButtons[key] = { button = btn, stroke = stroke }
btn.MouseButton1Click:Connect(function()
local slot =
ProfileCollection.pages[ProfileCollection.activePage].slots[ProfileCollection.activeSlot]
slot.flags[key] = not slot.flags[key]
_pcSetFlagVisual(key, slot.flags[key])
end)
end
_pcMkLabel("Count per pet", 0, 170, 0.48)

local pcCountBox = _pcMkBox("20", 0, 0.48, 184)
_pcMkLabel("Interval (sec)", 0.52, 170, 0.48)
local pcIntervalBox = _pcMkBox("0.5", 0.52, 0.48, 184)
_pcMkLabel("Quick-pick high tiers (click to add to current page+slot)", 0, 214, 1)
local pcQuickScroll = Instance.new("ScrollingFrame")
pcQuickScroll.Size = UDim2.new(1, 0, 0, 110)
pcQuickScroll.Position = UDim2.new(0, 0, 0, 228)
pcQuickScroll.BackgroundColor3 = Color3.fromRGB(25, 25, 35)
pcQuickScroll.BackgroundTransparency = 0.4
pcQuickScroll.BorderSizePixel = 0
pcQuickScroll.ScrollBarThickness = 4
pcQuickScroll.ScrollBarImageColor3 = Color3.fromRGB(100, 100, 100)
pcQuickScroll.CanvasSize = UDim2.new(0, 0, 0, 0)
pcQuickScroll.AutomaticCanvasSize = Enum.AutomaticSize.Y
pcQuickScroll.Parent = pcSection
Instance.new("UICorner", pcQuickScroll).CornerRadius = UDim.new(0, 4)
local quickLayout = Instance.new("UIListLayout")
quickLayout.SortOrder = Enum.SortOrder.LayoutOrder
quickLayout.Padding = UDim.new(0, 2)
quickLayout.Parent = pcQuickScroll
local quickPad = Instance.new("UIPadding")
quickPad.PaddingTop = UDim.new(0, 3)
quickPad.PaddingLeft = UDim.new(0, 3)
quickPad.PaddingRight = UDim.new(0, 3)
quickPad.Parent = pcQuickScroll
local function _pcCurrentSlot()
return
ProfileCollection.pages[ProfileCollection.activePage].slots[ProfileCollection.activeSlot]
end
local function _pcSaveCurrentSlotState()
_pcCurrentSlot().names = pcPetBox.Text or ""
end
local function _pcLoadCurrentSlotState()
local slot = _pcCurrentSlot()
pcPetBox.Text = slot.names or ""
for _, key in ipairs(_pcFlagOrder) do
_pcSetFlagVisual(key, slot.flags[key])
end
end
local function _pcHighlightPage(idx)
for j, b in ipairs(pcPageTabs) do
b.BackgroundColor3 = (j == idx) and Color3.fromRGB(160, 100, 60) or
Color3.fromRGB(50, 50, 60)
end
end

local function _pcHighlightSlot(idx)
for j, b in ipairs(pcSlotTabs) do
b.BackgroundColor3 = (j == idx) and Color3.fromRGB(80, 140, 200) or
Color3.fromRGB(50, 50, 60)
end
end
for i, btn in ipairs(pcPageTabs) do
btn.MouseButton1Click:Connect(function()
_pcSaveCurrentSlotState()
ProfileCollection.activePage = i
_pcHighlightPage(i)
_pcLoadCurrentSlotState()
end)
end
for i, btn in ipairs(pcSlotTabs) do
btn.MouseButton1Click:Connect(function()
_pcSaveCurrentSlotState()
ProfileCollection.activeSlot = i
_pcHighlightSlot(i)
_pcLoadCurrentSlotState()
end)
end
pcPetBox:GetPropertyChangedSignal("Text"):Connect(function()
_pcCurrentSlot().names = pcPetBox.Text
end)
...
btn.MouseButton1Click:Connect(function()
local slot = _pcCurrentSlot()
local cur = slot.names or ""
if cur ~= "" and cur:sub(-1) ~= "\n" then cur = cur .. "\n" end
slot.names = cur .. petName

pcPetBox.Text = slot.names
Services.TweenService:Create(btn, TweenInfo.new(0.15), { BackgroundColor3 =
Color3.fromRGB(80, 160, 90) }):Play()
task.delay(0.2, function()
Services.TweenService:Create(btn, TweenInfo.new(0.2), { BackgroundColor3 =
Color3.fromRGB(45, 45, 60) }):Play()
end)
end)
end
local pcToggleBtn = Instance.new("TextButton")
pcToggleBtn.Size = UDim2.new(0.31, 0, 0, 24)
pcToggleBtn.Position = UDim2.new(0, 0, 0, 346)
pcToggleBtn.BackgroundColor3 = Color3.fromRGB(50, 110, 60)
pcToggleBtn.BackgroundTransparency = 0.2
pcToggleBtn.Text = "Auto: OFF"
pcToggleBtn.Font = Enum.Font.FredokaOne
pcToggleBtn.TextSize = 11
pcToggleBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
pcToggleBtn.Parent = pcSection
Instance.new("UICorner", pcToggleBtn).CornerRadius = UDim.new(0, 4)
local pcRefreshNowBtn = Instance.new("TextButton")
pcRefreshNowBtn.Size = UDim2.new(0.31, 0, 0, 24)
pcRefreshNowBtn.Position = UDim2.new(0.345, 0, 0, 346)
pcRefreshNowBtn.BackgroundColor3 = Color3.fromRGB(60, 90, 150)
pcRefreshNowBtn.BackgroundTransparency = 0.2
pcRefreshNowBtn.Text = "Refresh"
pcRefreshNowBtn.Font = Enum.Font.FredokaOne
pcRefreshNowBtn.TextSize = 11
pcRefreshNowBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
pcRefreshNowBtn.Parent = pcSection
Instance.new("UICorner", pcRefreshNowBtn).CornerRadius = UDim.new(0, 4)
local pcFillAllBtn = Instance.new("TextButton")
pcFillAllBtn.Size = UDim2.new(0.31, 0, 0, 24)
pcFillAllBtn.Position = UDim2.new(0.69, 0, 0, 346)
pcFillAllBtn.BackgroundColor3 = Color3.fromRGB(150, 80, 160)
pcFillAllBtn.BackgroundTransparency = 0.2
pcFillAllBtn.Text = "Fill all slots"
pcFillAllBtn.Font = Enum.Font.FredokaOne
pcFillAllBtn.TextSize = 11
pcFillAllBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
pcFillAllBtn.Parent = pcSection
Instance.new("UICorner", pcFillAllBtn).CornerRadius = UDim.new(0, 4)
ProfileCollection.fillForm = "FR"
local pcFillFormButtons = {}

local _pcFillFormOptions = { "MFR", "NFR", "FR", "Random" }
local _pcFillFormColors = {
MFR = Color3.fromRGB(140, 80, 180),
NFR = Color3.fromRGB(70, 170, 80),
FR = Color3.fromRGB(60, 130, 180),
Random = Color3.fromRGB(180, 130, 60),
}
for i, opt in ipairs(_pcFillFormOptions) do
local btn = Instance.new("TextButton")
btn.Size = UDim2.new(0.235, 0, 0, 22)
btn.Position = UDim2.new((i - 1) * 0.255, 0, 0, 374)
btn.BackgroundColor3 = (opt == ProfileCollection.fillForm) and _pcFillFormColors[opt]
...
btn.Parent = pcSection
Instance.new("UICorner", btn).CornerRadius = UDim.new(0, 4)
pcFillFormButtons[opt] = btn
btn.MouseButton1Click:Connect(function()
ProfileCollection.fillForm = opt
for k, b in pairs(pcFillFormButtons) do
b.BackgroundColor3 = (k == opt) and _pcFillFormColors[k] or Color3.fromRGB(50,
50, 60)
end
end)
end
local pcStatusLabel = Instance.new("TextLabel")
pcStatusLabel.Size = UDim2.new(1, 0, 0, 60)
pcStatusLabel.Position = UDim2.new(0, 0, 0, 404)
pcStatusLabel.BackgroundTransparency = 1
pcStatusLabel.Text = "idle"
pcStatusLabel.Font = Enum.Font.SourceSans
pcStatusLabel.TextSize = 10
pcStatusLabel.TextColor3 = Color3.fromRGB(160, 160, 160)
pcStatusLabel.TextXAlignment = Enum.TextXAlignment.Left
pcStatusLabel.TextYAlignment = Enum.TextYAlignment.Top
pcStatusLabel.TextWrapped = true
pcStatusLabel.Parent = pcSection
local function _pcParseNamesFor(text)
local out = {}
...
local function _pcGetSpawnedUnique(kind)
for _, petData in ipairs(Spawning.FakePetRegistry) do
if petData and petData.wrapper and petData.wrapper.pet_id == kind and
petData.wrapper.pet_unique then
return petData.wrapper.pet_unique
end
end
return nil
end
local function _pcApplyFormToWrapper(kind, form)
local n, m = false, false
if form == "MFR" then m = true
elseif form == "NFR" then n = true
end
local touched = false
pcall(function()
updateData("pet_char_wrappers", function(wrappers)
for _, w in ipairs(wrappers) do
if w.pet_id == kind then
w.neon = n
w.mega_neon = m
w.flyable = true
w.rideable = true
...
for _, petEntry in pairs(inventory.pets) do
if petEntry and petEntry.kind == kind then
petEntry.properties = petEntry.properties or {}
petEntry.properties.neon = n and true or nil
petEntry.properties.mega_neon = m and true or nil
petEntry.properties.flyable = true
petEntry.properties.rideable = true
touched = true
end
end
end
...
end)
for _, petData in ipairs(Spawning.FakePetRegistry) do
if petData and petData.wrapper and petData.wrapper.pet_id == kind then
petData.wrapper.neon = n
petData.wrapper.mega_neon = m
petData.wrapper.flyable = true
petData.wrapper.rideable = true
end
end
return touched
end
local function _pcBuildPropsFor(flags)
local p = {}
if flags.F then p.flyable = true end
if flags.R then p.rideable = true end
if flags.N then p.neon = true end
if flags.M then p.mega_neon = true; p.neon = true end
return p
end
local function _pcBuildItemsForPageSlot(pageIdx, slotIdx, overrideFlags)
local slot = ProfileCollection.pages[pageIdx].slots[slotIdx]
local names = _pcParseNamesFor(slot.names)
local count = math.max(1, math.floor(tonumber(pcCountBox.Text) or 1))
local props = _pcBuildPropsFor(overrideFlags or slot.flags)
local items, resolved, missing = {}, 0, {}
for _, name in ipairs(names) do
local kind = GetKindPet(name)
if kind then
resolved = resolved + 1
local key = ("p%d_s%d_%s"):format(pageIdx, slotIdx, kind)
ProfileCollection.uniqueMap[key] = ProfileCollection.uniqueMap[key] or {}
for i = 1, count do
local unique = (i == 1 and _pcGetSpawnedUnique(kind)) or nil
if not unique then
if not ProfileCollection.uniqueMap[key][i] then
ProfileCollection.uniqueMap[key][i] =
Services.HttpService:GenerateGUID(false)
end
unique = ProfileCollection.uniqueMap[key][i]
end
local copy = {}
for k, v in pairs(props) do copy[k] = v end
table.insert(items, { kind = kind, category = "pets", unique = unique, properties =
copy })
...
local function _pcSaveTo(page, slot, items)
local slotData = { widget_kind = "collection", widget_data = { title = "Have", items =
items } }
local ok, err = pcall(function()
Modules.RouterClient.get("PlayerProfileAPI/SaveProfileSlot"):FireServer(page, slot,
slotData)
end)
return ok, err
end
local _pcRefreshBusy = false
local function _pcRefreshAll()
if _pcRefreshBusy then return false end
_pcRefreshBusy = true
_pcSaveCurrentSlotState()
local populated = {}
local totalItems, totalResolved, allMissing = 0, 0, {}
for pageIdx = 1, PROFILE_PAGE_COUNT do
for slotIdx = 1, PROFILE_SLOT_COUNT do
local slot = ProfileCollection.pages[pageIdx].slots[slotIdx]
local overrideFlags = _pcFormFlagsFromName(slot.appliedForm)
if overrideFlags and slot.names ~= "" then
for _, name in ipairs(_pcParseNamesFor(slot.names)) do
local k = GetKindPet(name)
if k then _pcApplyFormToWrapper(k, slot.appliedForm) end
end
end
local items, resolved, missing = _pcBuildItemsForPageSlot(pageIdx, slotIdx,
overrideFlags)
if #items > 0 then
table.insert(populated, { page = pageIdx, slot = slotIdx, items = items })
totalItems = totalItems + #items
totalResolved = totalResolved + resolved
end
for _, m in ipairs(missing) do table.insert(allMissing, m) end
end
end
if totalItems == 0 then

pcStatusLabel.Text = "no valid pets to save (add some via quick-pick or text box)"
pcStatusLabel.TextColor3 = Color3.fromRGB(255, 150, 100)
_pcRefreshBusy = false
return false
end
local saved = 0
for i, p in ipairs(populated) do
pcStatusLabel.Text = ("refreshing p%d s%d [%d/%d]"):format(p.page, p.slot, i,
#populated)
pcStatusLabel.TextColor3 = Color3.fromRGB(255, 220, 100)
local ok = _pcSaveTo(p.page, p.slot, p.items)
if ok then saved = saved + 1 end
if i < #populated then
task.wait(ProfileCollection.perSlotDelay)
end
end
ProfileCollection.lastRefresh = tick()
local msg = ("refreshed %d/%d slots (%d items, %d pets)"):format(
saved, #populated, totalItems, totalResolved)
if #allMissing > 0 then msg = msg .. " | unknown: " .. table.concat(allMissing, ", ") end
pcStatusLabel.Text = msg
pcStatusLabel.TextColor3 = Color3.fromRGB(120, 220, 160)
_pcRefreshBusy = false
return true
end
pcToggleBtn.MouseButton1Click:Connect(function()
ProfileCollection.enabled = not ProfileCollection.enabled
if ProfileCollection.enabled then
pcToggleBtn.Text = "Auto-Refresh: ON"
pcToggleBtn.BackgroundColor3 = Color3.fromRGB(80, 160, 90)
ProfileCollection.lastRefresh = 0
else
pcToggleBtn.Text = "Auto-Refresh: OFF"
pcToggleBtn.BackgroundColor3 = Color3.fromRGB(50, 110, 60)
end
end)
pcRefreshNowBtn.MouseButton1Click:Connect(function() _pcRefreshAll() end)
local function _pcFlagsFromForm(form)
if form == "MFR" then return { F = true, R = true, N = false, M = true } end
if form == "NFR" then return { F = true, R = true, N = true, M = false } end
if form == "FR" then return { F = true, R = true, N = false, M = false } end
if form == "Random" then
local pick = { "MFR", "NFR", "FR" }
return _pcFlagsFromForm(pick[math.random(1, #pick)])

end
return { F = false, R = false, N = false, M = false }
end
pcFillAllBtn.MouseButton1Click:Connect(function()
if _pcRefreshBusy then return end
_pcRefreshBusy = true
task.spawn(function()
local plan = {}
local idx = 0
...
for slotIdx = 1, PROFILE_SLOT_COUNT do
idx = idx + 1
local petName = completePetList[idx]
if petName then
table.insert(plan, { page = pageIdx, slot = slotIdx, name = petName })
end
end
end
local total = #plan
local saved = 0
local form = ProfileCollection.fillForm or "FR"
local randomChoices = { "MFR", "NFR", "FR" }
local function _pcFlashForm(picked)
for k, b in pairs(pcFillFormButtons) do
b.BackgroundColor3 = (k == picked) and _pcFillFormColors[k] or
Color3.fromRGB(50, 50, 60)
end
end
for i, p in ipairs(plan) do
local slot = ProfileCollection.pages[p.page].slots[p.slot]
slot.names = p.name
if p.page == ProfileCollection.activePage and p.slot == ProfileCollection.activeSlot
then
pcPetBox.Text = p.name
end
local appliedForm = form
if form == "Random" then
appliedForm = randomChoices[math.random(1, #randomChoices)]
end
slot.appliedForm = appliedForm
_pcFlashForm(appliedForm)
local kind = GetKindPet(p.name)
if kind then _pcApplyFormToWrapper(kind, appliedForm) end
local formFlags = _pcFormFlagsFromName(appliedForm) or { F = true, R = true, N
= false, M = false }
local items = _pcBuildItemsForPageSlot(p.page, p.slot, formFlags)
if #items > 0 then

local ok = _pcSaveTo(p.page, p.slot, items)
if ok then saved = saved + 1 end
end
pcStatusLabel.Text = ("filling p%d s%d = %s [%s] [%d/%d]"):format(p.page, p.slot,
p.name, appliedForm, i, total)
pcStatusLabel.TextColor3 = Color3.fromRGB(180, 220, 255)
task.wait()
end
_pcFlashForm(ProfileCollection.fillForm or "FR")
pcStatusLabel.Text = ("filled %d/%d slots (form: %s)"):format(saved, total, form)
pcStatusLabel.TextColor3 = Color3.fromRGB(120, 220, 160)
_pcRefreshBusy = false
end)
end)
pcIntervalBox.FocusLost:Connect(function()
local v = tonumber(pcIntervalBox.Text)
if v and v >= 0.1 then ProfileCollection.intervalSec = v else pcIntervalBox.Text =
tostring(ProfileCollection.intervalSec) end
end)
task.spawn(function()
while true do
task.wait(0.25)
if ProfileCollection.enabled then
if tick() - ProfileCollection.lastRefresh >= ProfileCollection.intervalSec then
_pcRefreshAll()
end
end
end
...
local addedChars = #newText - #inputText
toyNameBox.CursorPosition = math.max(1, math.min(lastCursorPosition +
addedChars, #newText + 1))
return
end
...
toyCurrentColorTween = Services.TweenService:Create(toyBoxGlow,
TweenInfo.new(0.8, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Color =
targetColor})
...
local toyActiveAnimation = { endTime = 0, strokeTween = nil, resetThread = nil, intensity =
1.0, lastSuccess = false }
...
Services.TweenService:Create(toyButtonStroke, TweenInfo.new(0.2), { Thickness =
2, Transparency = 0.05 }):Play()
end
end)
...
Services.TweenService:Create(toyButtonStroke, TweenInfo.new(0.2), { Thickness =
toyOriginalProperties.StrokeThickness, Transparency =
toyOriginalProperties.StrokeTransparency }):Play()
...
coroutine.close(toyActiveAnimation.resetThread) end
local feedbackColor = Color3.fromRGB(255, 50, 50)
local spawnSuccess = false
if toy_name ~= "" then
...
createToy(toyId)
spawnSuccess = true
game.StarterGui:SetCore("SendNotification", { Title = "Toy Spawned!", Text =
toy_name .. " has been spawned!", Duration = 5 })
else
game.StarterGui:SetCore("SendNotification", { Title = "Error", Text = "Toy not
found: "..toy_name, Duration = 3 })
end
else
game.StarterGui:SetCore("SendNotification", { Title = "Error", Text = "Please enter a
toy name!", Duration = 3 })
...
if isExtension then
toyActiveAnimation.strokeTween = Services.TweenService:Create(toyButtonStroke,
TweenInfo.new(0.2, Enum.EasingStyle.Quad), { Thickness = 2.5 *
toyActiveAnimation.intensity, Transparency = 0.05 / toyActiveAnimation.intensity })
...
Services.TweenService:Create(toyButtonStroke, TweenInfo.new(0.5,
Enum.EasingStyle.Quad), { Color = toyOriginalProperties.StrokeColor, Thickness =
toyOriginalProperties.StrokeThickness, Transparency =
toyOriginalProperties.StrokeTransparency }):Play()
end
end)
...
if UIState.waitingForKeybind and input.UserInputType == Enum.UserInputType.Keyboard
then
local key = input.KeyCode
if key == Enum.KeyCode.Escape then
local button = SetsUI.keybindButtons[UIState.waitingForKeybind]
if button then button.Text = UIState.keybinds[UIState.waitingForKeybind].Name;
button.BackgroundColor3 = Color3.fromRGB(70, 65, 95) end
UIState.waitingForKeybind = nil
return
end
UIState.keybinds[UIState.waitingForKeybind] = key
local button = SetsUI.keybindButtons[UIState.waitingForKeybind]
if button then button.Text = key.Name; button.BackgroundColor3 = Color3.fromRGB(70,
65, 95) end
UIState.waitingForKeybind = nil
if Apps.HintApp then Apps.HintApp:hint({ text = 'Keybind set to ' .. key.Name, length =
2, overridable = true }) end
return
end
if input.UserInputType == Enum.UserInputType.Keyboard and not
UIState.waitingForKeybind then
local key = input.KeyCode
...
if Apps.HintApp then
Apps.HintApp:hint({ text = 'Partner set to ' .. partner.Name, length = 2,
overridable = true })
end
end
...
if mockState.active then
addPetToPartnerOffer(getRandomHighValuePet(),
generateRandomPetProperties())
end
end
...
if Apps.HintApp then
Apps.HintApp:hint({ text = 'Random user: ' .. randomUsername, length = 2,
overridable = true })
end
end
end
...
UIState.activeTabPulseTween = Services.TweenService:Create(data.stroke,
TweenInfo.new(1.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true), {
Color = Color3.fromRGB(100, 100, 255):Lerp(Color3.fromRGB(255, 255, 255), 0.25),
Thickness = 1.5
})
UIState.activeTabPulseTween:Play()
end
...
e.ZIndex = 100
e.Parent = tradeFrame
Services.TweenService:Create(e, TweenInfo.new(0.2, Enum.EasingStyle.Back,
...
local el = tick() - st
if el >= dur or not e.Parent then c:Disconnect() if e.Parent then e:Destroy() end return
end
local newY = e.Position.Y.Scale - spd * dt
local drift = math.sin(el * 4) * dt * 0.0
e.Position = UDim2.new(math.clamp(e.Position.X.Scale + drift, 0.85, 0.98), 0, newY,
0)
...
createSpacer(UI.controlFrame)
createButton('
Auto Partner Emoji: OFF', Color3.fromRGB(150, 50, 50),
Color3.fromRGB(255, 100, 100), UI.controlFrame, function()
...
if collectionData and collectionData.items and type(collectionData.items)
== 'table' then
...
print("[SuggestInventory] try_suggest_item called - checking if mock trade")
if not mockState.active or not mockState.trade then
print("[SuggestInventory] Not in mock trade, using original")
...
print("[SuggestInventory] NEW TRADE DETECTED - Clearing old cache")
suggestInventoryCache = {}
lastTradeId = currentTradeId
end
if suggestInventoryCache[currentTradeId] then
print("[SuggestInventory] Access already granted this trade - opening
inventory directly")
...
print("[SuggestInventory] Restored original Modules.ClientData.get")
end)
end
return

end
print("[SuggestInventory] First time in this trade - auto-granting backpack
access")
local partner = self:_get_partner()
if not partner then
print("[SuggestInventory] No partner found")
return
end
...
task.wait(0.5)
print("[SuggestInventory] Loading collection for:", partner.Name, "UserId:",
partner.UserId)
local collectionData = GetPlayerCollectionPets(partner.UserId)
print("[SuggestInventory] Collection loaded - Pets found:", collectionData.pets
and #collectionData.pets or 0)
local hasPets = collectionData.pets and #collectionData.pets > 0
if self.UIManager.apps.DialogApp then
local dialogText = ""
if hasPets then
dialogText = (("%* has granted you access to view their backpack! Make a
suggestion now?"):format(partner.Name))
else
dialogText = (("%* has granted you access to view their backpack!\n\nNote:
Their collection is empty or private."):format(partner.Name))
end
local response = self.UIManager.apps.DialogApp:dialog({
text = dialogText,
left = "Cancel",
right = hasPets and "Suggest" or "Okay"
})
...
print("[SuggestInventory] Creating fake inventory with", #collectionData.pets,
"pets")
...
pet_trick_level = (pet.properties and
tonumber(pet.properties.pet_trick_level)) or 0,
neon = (pet.properties and pet.properties.neon) or false,
mega_neon = (pet.properties and pet.properties.mega_neon) or
false,
...
custom_name = (pet.properties and pet.properties.custom_name)
or nil
}
}
...
newnessOrder = newnessOrder - 1
end
end
end
print("[SuggestInventory] Successfully created", successCount, "fake pets")
suggestInventoryCache[currentTradeId] = overrideInventory
self.backpack_access = true
local BackpackApp = self.UIManager.apps.BackpackApp
if not BackpackApp then
print("[SuggestInventory] BackpackApp not found")
return
end
local OriginalClientDataGet = Modules.ClientData.get
Modules.ClientData.get = function(key)
...
if not mockState.active or not mockState.trade then
print("[SuggestAutoAccept] Not in mock trade, using original suggest_item")
return self._original_suggest_item(self, specific_item)
end
print("[SuggestAutoAccept] In mock trade - handling suggestion")
...
title_override = ("%*'S
BACKPACK"):format((self:_get_partner().Name:upper())),
...
return (not suggestion or suggestion.item_owner == my_player) and true or
false
end
})
...
print("[SuggestAutoAccept] Picked item:", picked_item.kind,
picked_item.unique)
...
print("[SuggestAutoAccept] Pet name:", petName)
self:_render_suggestion(picked_item.unique, self:_get_partner())
task.spawn(function()
task.wait(math.random(15, 30) / 10)
print("[SuggestAutoAccept] Auto-accepting suggestion for:", petName)
self:_render_suggestion_finalized(picked_item.unique, true,
Services.Players.LocalPlayer)
...
if success then
print("[SuggestAutoAccept] Successfully added pet to partner offer:",
petName)
else
warn("[SuggestAutoAccept] Failed to add pet:", message)
end
end)
return true
end
print("[SuggestInventory] Complete suggest system loaded!")
end
end)
end)
task.spawn(function()
...
print("[SuggestInventory] Cleared cache for ended trade:", tradeId)
end
lastTradeId = nil
print("[SuggestInventory] Reset lastTradeId - next trade will reload backpack")
end
...
print("[SuggestInventory] Complete auto-suggest system initialized!")
